...
impl From<BItem> for BlockStmt {
    fn from(value: BItem) -> Self {
        BlockStmt::Item(value)
    }
}

impl From<StmtLet> for BlockStmt {
    fn from(value: StmtLet) -> Self {
        BlockStmt::Let(value)
    }
}

impl From<BlockStmtExpr> for BlockStmt {
    fn from(value: BlockStmtExpr) -> Self {
        BlockStmt::Expr(value)
    }
}

impl From<AnyBox> for BlockStmt {
