...
impl From<Ty> for ExprInvokeTarget {
    fn from(value: Ty) -> Self {
        ExprInvokeTarget::Type(value)
    }
}

impl From<ExprSelect> for ExprInvokeTarget {
    fn from(value: ExprSelect) -> Self {
        ExprInvokeTarget::Method(value)
    }
}

impl From<ValueFunction> for ExprInvokeTarget {
    fn from(value: ValueFunction) -> Self {
        ExprInvokeTarget::Closure(value)
    }
}

impl From<BinOpKind> for ExprInvokeTarget {
    fn from(value: BinOpKind) -> Self {
        ExprInvokeTarget::BinOp(value)
    }
}

impl From<BExpr> for ExprInvokeTarget {
    fn from(value: BExpr) -> Self {
        ExprInvokeTarget::Expr(value)
    }
}
...
impl From<String> for FormatTemplatePart {
    fn from(value: String) -> Self {
        FormatTemplatePart::Literal(value)
    }
}

impl From<FormatPlaceholder> for FormatTemplatePart {
    fn from(value: FormatPlaceholder) -> Self {
        FormatTemplatePart::Placeholder(value)
    }
}
...
impl From<usize> for FormatArgRef {
    fn from(value: usize) -> Self {
        FormatArgRef::Positional(value)
    }
}

impl From<String> for FormatArgRef {
    fn from(value: String) -> Self {
        FormatArgRef::Named(value)
    }
}
