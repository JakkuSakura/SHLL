...
impl LlvmContext {
    ...
    // functions moved to llvm/functions.rs
    ...
    // values moved to llvm/values.rs
    // builder moved to llvm/builder.rs

    // builder methods moved to llvm/builder.rs
