...
fn test_generic_function_discovery() -> Result<()> {
    ...
    assert_eq!(
        ...
        1,
        "Should discover 1 generic function"
    );
...
fn test_struct_discovery() -> Result<()> {
    ...
    assert_eq!(
        generic_candidates.len(),
        1,
        "Should discover 1 struct candidate"
    );
...
fn test_multiple_generic_functions() -> Result<()> {
    ...
    assert_eq!(
        generic_candidates.len(),
        3,
        "Should discover 3 generic functions"
    );
...
fn test_nested_module_discovery() -> Result<()> {
    ...
    assert_eq!(
        generic_candidates.len(),
        2,
        "Should discover 2 candidates (1 generic function, 1 struct)"
    );
