...
pub fn read_dir(path: &::std::path::Path) -> ::std::alloc::Vec<&str> { compile_error!("compiler intrinsic") }

#[intrinsic = "fs_walk_dir"]
pub fn walk_dir(path: &::std::path::Path) -> ::std::alloc::Vec<&str> { compile_error!("compiler intrinsic") }
...
#[intrinsic = "fs_glob"]
pub fn glob(pattern: &str) -> ::std::alloc::Vec<&str> { compile_error!("compiler intrinsic") }
