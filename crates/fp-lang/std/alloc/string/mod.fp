...
pub fn raw_parts_to_str(ptr: *const ::libc::char, len: usize) -> &str {
...
impl String {
    ...
    pub fn as_str(&self) -> &str {
        raw_parts_to_str(self.ptr as *const ::libc::char, self.len)
    }
...
impl str {
    ...
    pub fn lines(&self) -> ::alloc::Vec<&str> { compile_error!("compiler intrinsic") }
...
impl String {
    ...
    pub fn lines(&self) -> ::alloc::Vec<&str> {
        compile_error!("compiler intrinsic")
    }
}
