...
impl Path {
    ...
    pub fn file_name(&self) -> ::core::option::Option<&str> {
        option_str(::std::intrinsics::path::file_name(self.inner))
    }

    pub fn extension(&self) -> ::core::option::Option<&str> {
        option_str(::std::intrinsics::path::extension(self.inner))
    }

    pub fn stem(&self) -> ::core::option::Option<&str> {
    ...
    pub fn has_extension(&self, extension: &str) -> bool {
        match self.extension() {
            ::core::option::Option::Some(current) => current == extension,
...
fn option_str(value: &str) -> ::core::option::Option<&str> {
    if value == "" {
        ::core::option::none()
    } else {
...
fn option_path_buf(value: &str) -> ::core::option::Option<PathBuf> {
    if value == "" {
        ::core::option::none()
    } else {
        ::core::option::some(PathBuf::from(value))
    }
}
