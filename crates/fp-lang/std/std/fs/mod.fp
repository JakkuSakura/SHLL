...
impl OpenOptions {
    ...
    #[unimplemented]
    pub fn open(self, path: &::std::path::Path) -> ::core::result::Result<File, IoError> {
        let _ = self;
        let _ = path;
...
impl File {
    pub fn open(path: &::std::path::Path) -> ::core::result::Result<File, IoError> {
        OpenOptions::new().read(true).open(path)
    }

    pub fn create(path: &::std::path::Path) -> ::core::result::Result<File, IoError> {
        OpenOptions::new()
            .write(true)
            .truncate(true)
            .create(true)
    ...
    #[unimplemented]
    pub fn metadata(&self) -> ::core::result::Result<Metadata, IoError> {
        let _ = self.fd;
        compile_error!("::std::fs::File::metadata is not implemented for the current std surface")
    }

    #[unimplemented]
    pub fn read_to_string(&mut self) -> ::core::result::Result<str, IoError> {
        let _ = self.fd;
        compile_error!("::std::fs::File::read_to_string is not implemented for the current std surface")
    }

    #[unimplemented]
    pub fn write_all(&mut self, content: &str) -> ::core::result::Result<(), IoError> {
        let _ = self;
        let _ = content;
        compile_error!("::std::fs::File::write_all is not implemented for the current std surface")
    }

    pub fn flush(&mut self) -> ::core::result::Result<(), IoError> {
        ::core::result::Result::Ok(())
    }

    #[unimplemented]
    pub fn sync_all(&mut self) -> ::core::result::Result<(), IoError> {
        let _ = self;
        compile_error!("::std::fs::File::sync_all is not implemented for the current std surface")
    }

    #[unimplemented]
    pub fn seek(&mut self, pos: SeekFrom) -> ::core::result::Result<i64, IoError> {
        let _ = self;
        let _ = pos;
    ...
    #[unimplemented]
    pub fn close(self) -> ::core::result::Result<(), IoError> {
        let _ = self;
...
#[op(func = "fs_read_dir")]
pub fn read_dir(path: &::std::path::Path) -> ::alloc::Vec<&str> { ::std::intrinsics::fs::read_dir(path) }

#[op(func = "fs_walk_dir")]
pub fn walk_dir(path: &::std::path::Path) -> ::alloc::Vec<&str> { ::std::intrinsics::fs::walk_dir(path) }
...
#[op(func = "fs_glob")]
pub fn glob(pattern: &str) -> ::alloc::Vec<&str> { ::std::intrinsics::fs::glob(pattern) }
