...
pub struct CraneliftConfig {
    ...
    /// Target CPU (e.g. "native"), forwarded into Cranelift ISA config.
    pub target_cpu: Option<String>,
    /// Target feature string (e.g. "+avx2"), forwarded into Cranelift ISA config.
    pub target_features: Option<String>,
    /// Optional sysroot for cross compilation.
    pub sysroot: Option<PathBuf>,
    /// Linker driver to invoke (used by the CLI linker stage).
    pub linker_driver: Option<String>,
    /// Explicit link-editor override.
