...
const LANG_INSTRINSTICS: &[LangIntrinsicSpec] = &[
    ...
    LangIntrinsicSpec {
        intrinsic: LangIntrinsic::SerdeJsonFromStr,
        lang_item: "serde_json_from_str",
        capability: LangIntrinsicCapability::Portable,
        call_kind: Some(CallKind::SerdeJsonFromStr),
    },
    LangIntrinsicSpec {
        intrinsic: LangIntrinsic::SerdeJsonToString,
        lang_item: "serde_json_to_string",
        capability: LangIntrinsicCapability::Portable,
        call_kind: Some(CallKind::SerdeJsonToString),
    },
    LangIntrinsicSpec {
        intrinsic: LangIntrinsic::TomlFromStr,
        lang_item: "toml_from_str",
        capability: LangIntrinsicCapability::Portable,
        call_kind: Some(CallKind::TomlFromStr),
    },
    LangIntrinsicSpec {
        intrinsic: LangIntrinsic::TokioTcpConnect,
        lang_item: "tokio_tcp_connect",
        capability: LangIntrinsicCapability::Portable,
        call_kind: Some(CallKind::TokioTcpConnect),
    },
    LangIntrinsicSpec {
        intrinsic: LangIntrinsic::TokioTcpWriteAll,
        lang_item: "tokio_tcp_write_all",
        capability: LangIntrinsicCapability::Portable,
        call_kind: Some(CallKind::TokioTcpWriteAll),
    },
    LangIntrinsicSpec {
        intrinsic: LangIntrinsic::Sleep,
        lang_item: "sleep",
        capability: LangIntrinsicCapability::Portable,
        call_kind: Some(CallKind::Sleep),
    },
    LangIntrinsicSpec {
