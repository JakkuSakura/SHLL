...
fn build_x86_64_macho_object_with_darwin_syscalls() -> Vec<u8> {
    ...
    text.extend_from_slice(&[0x48, 0xC7, 0xC0, 0x04, 0x00, 0x00, 0x02]);
    text.extend_from_slice(&[0x48, 0xC7, 0xC7, 0x01, 0x00, 0x00, 0x00]);
    text.extend_from_slice(&[0x48, 0x89, 0xE6]);
    text.extend_from_slice(&[0x48, 0xC7, 0xC2, 0x03, 0x00, 0x00, 0x00]);
    text.extend_from_slice(&[0x0F, 0x05]);
    text.extend_from_slice(&[0x48, 0xC7, 0xC0, 0x01, 0x00, 0x00, 0x02]);
...
#[cfg(target_os = "macos")]
#[tokio::test]
async fn compile_macho_x86_64_object_to_aarch64_macho_exec_and_run() {
