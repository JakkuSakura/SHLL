...
fn parse_intrinsic_kind(raw: &str) -> Result<IntrinsicKind, BytecodeError> {
    match raw {
        ...
        "JsonParse" => Ok(IntrinsicKind::JsonParse),
        "YamlToJson" => Ok(IntrinsicKind::YamlToJson),
        "ProcMacroTokenStreamFromStr" => Ok(IntrinsicKind::ProcMacroTokenStreamFromStr),
        "CatchUnwind" => Ok(IntrinsicKind::CatchUnwind),
        "Spawn" => Ok(IntrinsicKind::Spawn),
        "Join" => Ok(IntrinsicKind::Join),
        "Select" => Ok(IntrinsicKind::Select),
        "Yield" => Ok(IntrinsicKind::Yield),
        "ShellExec" => Ok(IntrinsicKind::ShellExec),
