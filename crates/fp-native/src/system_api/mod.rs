use fp_core::asmir::{
    ...
    AsmGlobalRelocation, AsmInstruction, AsmInstructionKind, AsmObjectFormat, AsmOpcode, AsmProgram,
    AsmRelocationKind, AsmSection, AsmSectionFlag, AsmSectionKind, AsmSysOp, AsmSyscallConvention,
    AsmTerminator, AsmType, AsmValue, PosixDirentStyle, PosixFlagStyle,
};
