...
@.str.21_build_blocks.0 = constant [51 x i8] c"test result: %lld passed; %lld failed; %lld total\0A\00"
@.str.21_build_blocks.1 = constant [13 x i8] c"  %s ... ok\0A\00"
@.str.21_build_blocks.2 = constant [17 x i8] c"  %s ... FAILED\0A\00"
@.str.21_build_blocks.3 = constant [35 x i8] c"\F0\9F\93\98 Tutorial: 21_build_blocks.fp\0A\00"
@.str.21_build_blocks.4 = constant [80 x i8] c"\F0\9F\A7\AD Focus: Build blocks with typed quote tokens and expression-driven splice.\0A\00"
@.str.21_build_blocks.5 = constant [46 x i8] c"\F0\9F\A7\AA What to look for: labeled outputs below\0A\00"
@.str.21_build_blocks.6 = constant [39 x i8] c"\E2\9C\85 Expectation: outputs match labels\0A\00"
@.str.21_build_blocks.7 = constant [2 x i8] c"\0A\00"
@.str.21_build_blocks.8 = constant [41 x i8] c"build_items(true) -> Alpha { id: %lld }\0A\00"
@.str.21_build_blocks.9 = constant [43 x i8] c"build_items_2(false) -> Beta { id: %lld }\0A\00"
@.str.21_build_blocks.10 = constant [39 x i8] c"generated types are usable at runtime\0A\00"
...
bb3:                                              ; preds = %bb1
  ...
  %call_56 = call i32 (ptr, ...) @printf(ptr @.str.21_build_blocks.0, i64 %load_53, i64 %load_54, i64 %load_55)
  br label %bb12
...
bb7:                                              ; preds = %bb6
  ...
  %call_77 = call i32 (ptr, ...) @printf(ptr @.str.21_build_blocks.1, { ptr, i64 } %load_76)
  br label %bb10
...
bb8:                                              ; preds = %bb6
  ...
  %call_83 = call i32 (ptr, ...) @printf(ptr @.str.21_build_blocks.2, { ptr, i64 } %load_82)
  br label %bb11
...
bb0:
  ...
  %call_91 = call i32 (ptr, ...) @printf(ptr @.str.21_build_blocks.3)
  br label %bb1

bb1:                                              ; preds = %bb0
  %call_92 = call i32 (ptr, ...) @printf(ptr @.str.21_build_blocks.4)
  br label %bb2

bb2:                                              ; preds = %bb1
  %call_93 = call i32 (ptr, ...) @printf(ptr @.str.21_build_blocks.5)
  br label %bb3

bb3:                                              ; preds = %bb2
  %call_94 = call i32 (ptr, ...) @printf(ptr @.str.21_build_blocks.6)
  br label %bb4

bb4:                                              ; preds = %bb3
  %call_95 = call i32 (ptr, ...) @printf(ptr @.str.21_build_blocks.7)
  br label %bb5

bb5:                                              ; preds = %bb4
  store { i64 } { i64 1 }, ptr %alloca_count_96, align 8
  %load_99 = load i64, ptr %alloca_count_96, align 8
  %call_100 = call i32 (ptr, ...) @printf(ptr @.str.21_build_blocks.8, i64 %load_99)
  br label %bb6

bb6:                                              ; preds = %bb5
  store { i64 } { i64 2 }, ptr %alloca_count_101, align 8
  %load_104 = load i64, ptr %alloca_count_101, align 8
  %call_105 = call i32 (ptr, ...) @printf(ptr @.str.21_build_blocks.9, i64 %load_104)
  br label %bb7

bb7:                                              ; preds = %bb6
  %call_106 = call i32 (ptr, ...) @printf(ptr @.str.21_build_blocks.10)
  br label %bb8
