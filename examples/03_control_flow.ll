...
@.str.03_control_flow.0 = constant [5 x i8] c"warm\00", align 1
@.str.03_control_flow.1 = constant [15 x i8] [i8 37, i8 108, i8 108, i8 100, i8 194, i8 176, i8 67, i8 32, i8 105, i8 115, i8 32, i8 37, i8 115, i8 10, i8 0], align 1
@.str.03_control_flow.2 = constant [8 x i8] c"outdoor\00", align 1
@.str.03_control_flow.3 = constant [15 x i8] [i8 83, i8 117, i8 103, i8 103, i8 101, i8 115, i8 116, i8 101, i8 100, i8 58, i8 32, i8 37, i8 115, i8 10, i8 0], align 1
@.str.03_control_flow.4 = constant [2 x i8] c"B\00", align 1
@.str.03_control_flow.5 = constant [23 x i8] [i8 83, i8 99, i8 111, i8 114, i8 101, i8 32, i8 37, i8 108, i8 108, i8 100, i8 32, i8 61, i8 32, i8 103, i8 114, i8 97, i8 100, i8 101, i8 32, i8 37, i8 115, i8 10, i8 0], align 1
@.str.03_control_flow.6 = constant [5 x i8] c"high\00", align 1
@.str.03_control_flow.7 = constant [18 x i8] [i8 86, i8 97, i8 108, i8 117, i8 101, i8 32, i8 37, i8 108, i8 108, i8 100, i8 32, i8 105, i8 115, i8 32, i8 37, i8 115, i8 10, i8 0], align 1
@.str.03_control_flow.8 = constant [7 x i8] c"medium\00", align 1
@.str.03_control_flow.9 = constant [4 x i8] c"low\00", align 1
...
bb0:
  ...
  store ptr @.str.03_control_flow.0, ptr %alloca_3
...
bb1:
  ...
  store ptr @.str.03_control_flow.2, ptr %alloca_8
...
bb2:
  ...
  store ptr @.str.03_control_flow.4, ptr %alloca_14
...
bb4:
  store ptr @.str.03_control_flow.6, ptr %alloca_0
  br label %bb6
bb5:
...
bb6:
  ...
  br label %bb10
bb7:
  store ptr @.str.03_control_flow.8, ptr %alloca_0
  br label %bb9
bb8:
  store ptr @.str.03_control_flow.9, ptr %alloca_0
  br label %bb9
bb10:
  ret i32 0
bb9:
