...
@.str.09_higher_order_functions.2 = constant [6 x i8] [i8 37, i8 108, i8 108, i8 100, i8 10, i8 0], align 1
...
@.str.09_higher_order_functions.4 = constant [16 x i8] [i8 97, i8 100, i8 100, i8 95, i8 49, i8 48, i8 40, i8 53, i8 41, i8 32, i8 61, i8 32, i8 37, i8 115, i8 10, i8 0], align 1
@.str.09_higher_order_functions.5 = constant [10 x i8] c"<unknown>\00", align 1
@.str.09_higher_order_functions.6 = constant [18 x i8] [i8 100, i8 111, i8 117, i8 98, i8 108, i8 101, i8 40, i8 55, i8 41, i8 32, i8 61, i8 32, i8 37, i8 108, i8 108, i8 100, i8 10, i8 0], align 1
...
bb0:
  ...
  %add_43 = add i64 %arg0, %arg1
  store i64 %add_43, ptr %alloca_42
  %add_45 = add i64 %arg0, %arg1
  store i64 %add_45, ptr %alloca_41
  %load_47 = load i64, ptr %alloca_41
  ret i64 %load_47
}

define void @apply(double %arg0, double %arg1, ptr %arg2) {
bb0:
  ret void
}
...
bb0:
  ...
  br label %bb1
bb1:
  call void (double, double, ptr) @apply(double 1.000000e1, double 2.000000e1, ptr @add__spec0)
  br label %bb2
bb2:
  call void (double, double, ptr) @apply(double 1.500000e0, double 2.500000e0, ptr @add__spec0)
  br label %bb3
bb3:
...
bb9:
  ...
  br label %bb10
bb10:
  %alloca_36 = alloca { i8 }, align 1
  store { i8 } { i8 0 }, ptr %alloca_36
  %load_38 = load { i8 }, ptr %alloca_36
  %call_39 = call i64 ({ i8 }, i64) @__closure1_call({ i8 } %load_38, i64 7)
  br label %bb11
bb11:
