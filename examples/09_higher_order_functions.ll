...
bb0:
  ...
  %add_13 = add i64 %arg0, %arg1
  store i64 %add_13, ptr %alloca_12
...
bb0:
  %call_16 = call i64 (i64, i64) @add__i64(i64 %arg0, i64 %arg1)
  br label %bb1
bb1:
  %call_17 = call i32 (ptr, ...) @printf(ptr @.str.0, i64 %call_16)
  br label %bb2
bb2:
  ret void
}
...
bb0:
  %alloca_18 = alloca double, align 8
  %fadd_19 = fadd double %arg0, %arg1
  store double %fadd_19, ptr %alloca_18
  %load_21 = load double, ptr %alloca_18
  ret double %load_21
}

define void @apply__f64_op_add__f64(double %arg0, double %arg1) {
bb0:
  %call_22 = call double (double, double) @add__f64(double %arg0, double %arg1)
  br label %bb1
bb1:
  %call_23 = call i32 (ptr, ...) @printf(ptr @.str.1, double %call_22)
  br label %bb2
bb2:
  ret void
}
...
bb1:
  %call_25 = call i64 (i64, i64) @add__i64(i64 %arg1, i64 %arg2)
  store i64 %call_25, ptr %alloca_24
  br label %bb4
bb2:
  store i64 0, ptr %alloca_24
  br label %bb3
bb4:
  br label %bb3
bb3:
...
bb0:
  ...
  %insertvalue_30 = insertvalue { i64 } undef, i64 %arg0, 0
  store { i64 } %insertvalue_30, ptr %alloca_29
  %load_32 = load { i64 }, ptr %alloca_29
  ret { i64 } %load_32
}

define i32 @main() {
bb0:
  %call_33 = call i32 (ptr, ...) @printf(ptr @.str.2)
  br label %bb1
bb1:
...
bb2:
  ...
  br label %bb3
bb3:
  %call_36 = call i32 (ptr, ...) @printf(ptr @.str.3)
  br label %bb4
bb4:
  %call_37 = call i64 (i1, i64, i64) @apply_if__op_add__i64(i1 1, i64 5, i64 3)
  br label %bb5
bb5:
  %call_38 = call i32 (ptr, ...) @printf(ptr @.str.0, i64 %call_37)
  br label %bb6
bb6:
  %call_39 = call i64 (i1, i64, i64) @apply_if__op_add__i64(i1 0, i64 5, i64 3)
  br label %bb7
bb7:
  %call_40 = call i32 (ptr, ...) @printf(ptr @.str.0, i64 %call_39)
  br label %bb8
bb8:
  %call_41 = call i32 (ptr, ...) @printf(ptr @.str.4)
  br label %bb9
bb9:
  %call_42 = call { i64 } (i64) @make_adder(i64 10)
  br label %bb10
bb10:
  %call_43 = call i64 ({ i64 }, i64) @__closure0_call({ i64 } %call_42, i64 5)
  br label %bb11
bb11:
  %call_44 = call i32 (ptr, ...) @printf(ptr @.str.5, i64 %call_43)
  br label %bb12
bb12:
  %alloca_45 = alloca { i8 }, align 1
  store { i8 } { i8 0 }, ptr %alloca_45
  %load_47 = load { i8 }, ptr %alloca_45
  %call_48 = call i64 ({ i8 }, i64) @__closure1_call({ i8 } %load_47, i64 7)
  br label %bb13
bb13:
  %call_49 = call i32 (ptr, ...) @printf(ptr @.str.6, i64 %call_48)
  br label %bb14
bb14:
  ret i32 0
}
