...
bb0:
  ...
  store i64 %0, ptr %alloca_count_17, align 8
...
define i32 @main() {
bb0:
  %alloca_31 = alloca { i8 }, align 8
  %alloca_count_31 = alloca { i8 }, align 8
  %call_20 = call i32 (ptr, ...) @printf(ptr @.str.09_higher_order_functions.0)
  br label %bb1
...
bb3:                                              ; preds = %bb2
  %call_23 = call i32 (ptr, ...) @printf(ptr @.str.09_higher_order_functions.1)
  br label %bb4

bb4:                                              ; preds = %bb3
  %call_24 = call i64 @apply_if(i1 true, i64 5, i64 3, ptr @add__spec0)
  br label %bb5

bb5:                                              ; preds = %bb4
  %call_25 = call i32 (ptr, ...) @printf(ptr @.str.09_higher_order_functions.2, i64 %call_24)
  br label %bb6

bb6:                                              ; preds = %bb5
  %call_26 = call i64 @apply_if(i1 false, i64 5, i64 3, ptr @add__spec0)
  br label %bb7

bb7:                                              ; preds = %bb6
  %call_27 = call i32 (ptr, ...) @printf(ptr @.str.09_higher_order_functions.2, i64 %call_26)
  br label %bb8

bb8:                                              ; preds = %bb7
  %call_28 = call i32 (ptr, ...) @printf(ptr @.str.09_higher_order_functions.3)
  br label %bb9

bb9:                                              ; preds = %bb8
  %call_29 = call ptr @add_10(i64 5)
  br label %bb10

bb10:                                             ; preds = %bb9
  %call_30 = call i32 (ptr, ...) @printf(ptr @.str.09_higher_order_functions.4, ptr %call_29)
  br label %bb11

bb11:                                             ; preds = %bb10
  store { i8 } zeroinitializer, ptr %alloca_count_31, align 1
  %load_33 = load { i8 }, ptr %alloca_count_31, align 1
  %call_34 = call i64 @__closure1_call({ i8 } %load_33, i64 7)
  br label %bb12

bb12:                                             ; preds = %bb11
  %call_35 = call i32 (ptr, ...) @printf(ptr @.str.09_higher_order_functions.5, i64 %call_34)
  br label %bb13
...
bb0:
  %call_44 = call i64 %2(i64 %0, i64 %1)
  br label %bb1

bb1:                                              ; preds = %bb0
  %call_45 = call i32 (ptr, ...) @printf(ptr @.str.09_higher_order_functions.2, i64 %call_44)
  br label %bb2
...
bb0:
  ...
  %iop_41 = add i64 %ptrtoint, %ptrtoint1
  store i64 %iop_41, ptr %alloca_count_40, align 8
  %load_43 = load ptr, ptr %alloca_count_40, align 8
  ret ptr %load_43
}

define internal void @apply__mono_d7ad91e83a08a980_4(double %0, double %1, ptr %2) {
bb0:
  %call_46 = call double %2(double %0, double %1)
  br label %bb1

bb1:                                              ; preds = %bb0
  %call_47 = call i32 (ptr, ...) @printf(ptr @.str.09_higher_order_functions.6, double %call_46)
  br label %bb2
...
bb0:
  ...
  %iop_37 = add i64 %0, %1
  store i64 %iop_37, ptr %alloca_count_36, align 8
  %load_39 = load i64, ptr %alloca_count_36, align 8
  ret i64 %load_39
}

define internal ptr @add_10(i64 %0) {
bb0:
  %alloca_48 = alloca ptr, align 8
  %alloca_count_48 = alloca ptr, align 8
  store i64 0, ptr %alloca_count_48, align 8
