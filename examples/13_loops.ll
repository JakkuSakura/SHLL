...
@.str.13_loops.19 = private unnamed_addr constant [41 x i8] c"\0A6. Compile-time iteration (simulated):\0A\00", align 1
@.str.13_loops.20 = private unnamed_addr constant [19 x i8] c"  const 5! = %lld\0A\00", align 1
...
bb1:                                              ; preds = %bb2, %bb0
  %load_26 = load i64, ptr %alloca_count_20, align 8
...
bb2:                                              ; preds = %bb1
  ...
  store i64 %iop_32, ptr %alloca_count_22, align 8
  %load_34 = load i64, ptr %alloca_count_20, align 8
  %iop_35 = add i64 %load_34, 1
  store i64 %iop_35, ptr %alloca_count_20, align 8
  br label %bb1

bb3:                                              ; preds = %bb1
  %load_37 = load i64, ptr %alloca_count_22, align 8
  store i64 %load_37, ptr %alloca_count_21, align 8
  %load_39 = load i64, ptr %alloca_count_21, align 8
  ret i64 %load_39
}
...
bb0:
  ...
  store i64 2, ptr %alloca_count_41, align 8
  br label %bb1
...
bb2:                                              ; preds = %bb1
  %load_44 = load i64, ptr %alloca_count_41, align 8
  %load_45 = load i64, ptr %alloca_count_41, align 8
...
bb4:                                              ; preds = %bb2
  store i64 %0, ptr %alloca_count_40, align 8
  br label %bb3
...
bb3:                                              ; preds = %bb8, %bb4
  %load_54 = load i64, ptr %alloca_count_40, align 8
  ret i64 %load_54

bb6:                                              ; preds = %bb7, %bb5
  %load_56 = load i64, ptr %alloca_count_41, align 8
...
bb8:                                              ; preds = %bb6
  %load_64 = load i64, ptr %alloca_count_41, align 8
  store i64 %load_64, ptr %alloca_count_40, align 8
  br label %bb3
...
bb10:                                             ; preds = %bb11, %bb9
  %load_66 = load i64, ptr %alloca_count_41, align 8
  %iop_67 = add i64 %load_66, 1
  store i64 %iop_67, ptr %alloca_count_41, align 8
  br label %bb1
...
bb0:
  ...
  store i64 0, ptr %alloca_count_69, align 8
...
bb3:                                              ; preds = %bb1
  %load_91 = load i64, ptr %alloca_count_69, align 8
  store i64 %load_91, ptr %alloca_count_70, align 8
  %load_93 = load i64, ptr %alloca_count_70, align 8
  ret i64 %load_93
...
bb6:                                              ; preds = %bb7, %bb5
  %load_94 = load i64, ptr %alloca_count_69, align 8
  %load_95 = load i64, ptr %alloca_count_71, align 8
  %iop_96 = add i64 %load_94, %load_95
  store i64 %iop_96, ptr %alloca_count_69, align 8
  br label %bb1
...
bb0:
  ...
  %alloca_145 = alloca i1, align 1
  %alloca_count_145 = alloca i1, align 1
  %alloca_136 = alloca i1, align 1
  %alloca_count_136 = alloca i1, align 1
  %alloca_128 = alloca i1, align 1
  %alloca_count_128 = alloca i1, align 1
...
bb2:                                              ; preds = %bb1
  %call_103 = call i32 (ptr, ...) @printf(ptr @.str.13_loops.2)
  br label %bb3

bb3:                                              ; preds = %bb2
  %call_104 = call i32 (ptr, ...) @printf(ptr @.str.13_loops.3)
  br label %bb4

bb4:                                              ; preds = %bb3
  %call_105 = call i32 (ptr, ...) @printf(ptr @.str.13_loops.4)
  br label %bb5

bb5:                                              ; preds = %bb4
  %call_106 = call i32 (ptr, ...) @printf(ptr @.str.13_loops.5)
  br label %bb6

bb6:                                              ; preds = %bb5
  %call_107 = call i32 (ptr, ...) @printf(ptr @.str.13_loops.6)
  br label %bb7

bb7:                                              ; preds = %bb6
  %call_108 = call i64 @factorial(i64 5)
  br label %bb8

bb8:                                              ; preds = %bb7
  %call_109 = call i32 (ptr, ...) @printf(ptr @.str.13_loops.7, i64 %call_108)
  br label %bb9

bb9:                                              ; preds = %bb8
  %call_110 = call i64 @factorial(i64 7)
  br label %bb10

bb10:                                             ; preds = %bb9
  %call_111 = call i32 (ptr, ...) @printf(ptr @.str.13_loops.8, i64 %call_110)
  br label %bb11

bb11:                                             ; preds = %bb10
  %call_112 = call i32 (ptr, ...) @printf(ptr @.str.13_loops.9)
  br label %bb12

bb12:                                             ; preds = %bb11
  %call_113 = call i64 @sum_range(i64 1, i64 10)
  br label %bb13

bb13:                                             ; preds = %bb12
  %call_114 = call i32 (ptr, ...) @printf(ptr @.str.13_loops.10, i64 %call_113)
  br label %bb14

bb14:                                             ; preds = %bb13
  %call_115 = call i64 @sum_range(i64 5, i64 15)
  br label %bb15

bb15:                                             ; preds = %bb14
  %call_116 = call i32 (ptr, ...) @printf(ptr @.str.13_loops.11, i64 %call_115)
  br label %bb16

bb16:                                             ; preds = %bb15
  %call_117 = call i32 (ptr, ...) @printf(ptr @.str.13_loops.12)
  br label %bb17

bb17:                                             ; preds = %bb16
  %call_118 = call i64 @find_first_divisor(i64 24)
  br label %bb18

bb18:                                             ; preds = %bb17
  %call_119 = call i32 (ptr, ...) @printf(ptr @.str.13_loops.13, i64 %call_118)
  br label %bb19

bb19:                                             ; preds = %bb18
  %call_120 = call i64 @find_first_divisor(i64 17)
  br label %bb20

bb20:                                             ; preds = %bb19
  %call_121 = call i32 (ptr, ...) @printf(ptr @.str.13_loops.14, i64 %call_120)
  br label %bb21

bb21:                                             ; preds = %bb20
  %call_122 = call i32 (ptr, ...) @printf(ptr @.str.13_loops.15)
  br label %bb22

bb22:                                             ; preds = %bb21
  %call_123 = call i64 @sum_even_numbers(i64 10)
  br label %bb23

bb23:                                             ; preds = %bb22
  %call_124 = call i32 (ptr, ...) @printf(ptr @.str.13_loops.16, i64 %call_123)
  br label %bb24

bb24:                                             ; preds = %bb23
  %call_125 = call i32 (ptr, ...) @printf(ptr @.str.13_loops.17)
  br label %bb25

bb25:                                             ; preds = %bb24
  store i64 0, ptr %alloca_count_98, align 8
  store i64 1, ptr %alloca_count_100, align 8
  br label %bb26

bb26:                                             ; preds = %bb31, %bb25
  %load_129 = load i64, ptr %alloca_count_100, align 8
  %icmp_130 = icmp slt i64 %load_129, 4
  store i1 %icmp_130, ptr %alloca_count_128, align 1
  %load_132 = load i1, ptr %alloca_count_128, align 1
  br i1 %load_132, label %bb27, label %bb28
...
bb28:                                             ; preds = %bb26
  %load_134 = load i64, ptr %alloca_count_98, align 8
  %call_135 = call i32 (ptr, ...) @printf(ptr @.str.13_loops.18, i64 %load_134)
  br label %bb35

bb29:                                             ; preds = %bb34, %bb27
  %load_137 = load i64, ptr %alloca_count_99, align 8
  %icmp_138 = icmp slt i64 %load_137, 4
  store i1 %icmp_138, ptr %alloca_count_136, align 1
  %load_140 = load i1, ptr %alloca_count_136, align 1
  br i1 %load_140, label %bb30, label %bb31

bb35:                                             ; preds = %bb28
  %call_141 = call i32 (ptr, ...) @printf(ptr @.str.13_loops.19)
  br label %bb36

bb30:                                             ; preds = %bb29
  %load_142 = load i64, ptr %alloca_count_98, align 8
  %iop_143 = add i64 %load_142, 1
  store i64 %iop_143, ptr %alloca_count_98, align 8
  %load_146 = load i64, ptr %alloca_count_100, align 8
  %load_147 = load i64, ptr %alloca_count_99, align 8
  %icmp_148 = icmp eq i64 %load_146, %load_147
  store i1 %icmp_148, ptr %alloca_count_145, align 1
  %load_150 = load i1, ptr %alloca_count_145, align 1
  br i1 %load_150, label %bb32, label %bb33

bb31:                                             ; preds = %bb29
  %load_151 = load i64, ptr %alloca_count_100, align 8
  %iop_152 = add i64 %load_151, 1
  store i64 %iop_152, ptr %alloca_count_100, align 8
  br label %bb26

bb36:                                             ; preds = %bb35
  store i64 120, ptr %alloca_count_154, align 8
  %load_156 = load i64, ptr %alloca_count_154, align 8
  %call_157 = call i32 (ptr, ...) @printf(ptr @.str.13_loops.20, i64 %load_156)
  br label %bb37

bb32:                                             ; preds = %bb30
  %load_158 = load i64, ptr %alloca_count_100, align 8
  %call_159 = call i32 (ptr, ...) @printf(ptr @.str.13_loops.21, i64 %load_158)
  br label %bb34
...
bb37:                                             ; preds = %bb36
  %call_160 = call i32 (ptr, ...) @printf(ptr @.str.13_loops.22)
  br label %bb38

bb34:                                             ; preds = %bb33, %bb32
  %load_161 = load i64, ptr %alloca_count_99, align 8
  %iop_162 = add i64 %load_161, 1
  store i64 %iop_162, ptr %alloca_count_99, align 8
  br label %bb29
