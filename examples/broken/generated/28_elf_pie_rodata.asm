fp-native dump: format=MachO arch=Aarch64 entry=0x6070
...
fn main
  ...
  bb1 bb1
    ...
    load Virtual { id: 41, bank: General, size_bits: 64 }, mem(AsmMemoryOperand { base: Some(Virtual { id: 40, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: Some(8), address_space: None, pre_indexed: false, post_indexed: false })
    intrinsic.call symbol(intrinsic.println), Virtual { id: 41, bank: General, size_bits: 64 }, Virtual { id: 39, bank: General, size_bits: 64 }
    ret
...
Symbols:
  ...
  examples__28_elf_pie_rodata__sum 0x00005ecc
  main                             0x00006070

Text relocations:
  offset=0x00006090 kind=Aarch64AdrpAdd symbol=__const_data_0 addend=0
...
.text (25172 bytes):
  ...
  00005ec0  00 00 20 d4 c0 03 5f d6  c0 03 5f d6 ff 43 05 d1 
  00005ed0  fd 7b 14 a9 fd 03 00 91  e0 7b 00 f9 f0 03 00 91 
  00005ee0  10 62 04 91 f0 03 00 f9  f0 03 00 91 10 82 04 91 
  00005ef0  f0 07 00 f9 f0 03 00 91  10 a2 04 91 f0 0b 00 f9 
  00005f00  f1 07 40 f9 10 00 80 d2  30 02 00 f9 f1 0b 40 f9 
  00005f10  10 00 80 d2 30 02 00 f9  01 00 00 14 f0 03 00 91 
  00005f20  10 c2 04 91 f0 17 00 f9  f0 07 40 f9 11 02 40 f9 
  00005f30  f1 1b 00 f9 f0 1b 40 f9  1f 12 00 f1 f0 a7 9f 9a 
  00005f40  f0 1f 00 f9 f1 17 40 f9  f0 e3 40 39 30 02 00 39 
  00005f50  f0 17 40 f9 11 02 40 39  f1 27 00 f9 f0 23 41 39 
  00005f60  1f 06 00 f1 f0 17 9f 9a  f0 2b 00 f9 f0 2b 40 f9 
  00005f70  1f 02 00 f1 41 00 00 54  30 00 00 14 f0 03 00 91 
  00005f80  10 e2 04 91 f0 2f 00 f9  f0 07 40 f9 11 02 40 f9 
  00005f90  f1 33 00 f9 f1 2f 40 f9  f0 33 40 f9 30 02 00 f9 
  00005fa0  f0 0b 40 f9 11 02 40 f9  f1 3b 00 f9 f0 2f 40 f9 
  00005fb0  11 02 40 f9 f1 3f 00 f9  f0 3f 40 f9 11 01 80 d2 
  00005fc0  10 7e 11 9b f0 43 00 f9  f0 7b 40 f9 f0 47 00 f9 
  00005fd0  f0 47 40 f9 f1 43 40 f9  10 02 11 8b f0 4b 00 f9 
  00005fe0  f0 4b 40 f9 f0 4f 00 f9  f0 4f 40 f9 11 02 40 f9 
  00005ff0  f1 53 00 f9 f0 3b 40 f9  f1 53 40 f9 10 02 11 8b 
  00006000  f0 57 00 f9 f1 0b 40 f9  f0 57 40 f9 30 02 00 f9 
  00006010  f0 07 40 f9 11 02 40 f9  f1 5f 00 f9 f0 5f 40 f9 
  00006020  10 06 00 91 f0 63 00 f9  f1 07 40 f9 f0 63 40 f9 
  00006030  30 02 00 f9 ba ff ff 17  f0 0b 40 f9 11 02 40 f9 
  00006040  f1 6b 00 f9 f1 03 40 f9  f0 6b 40 f9 30 02 00 f9 
  00006050  f0 03 40 f9 11 02 40 f9  f1 73 00 f9 e0 73 40 f9 
  00006060  bf 03 00 91 fd 7b 54 a9  ff 43 05 91 c0 03 5f d6 
  00006070  ff 03 06 d1 fd 7b 17 a9  fd 03 00 91 f0 03 00 91 
  00006080  10 42 04 91 f0 0b 00 f9  f1 0b 40 f9 eb 03 11 aa 
  00006090  10 00 00 90 10 02 00 91  ea 03 0b aa 50 01 00 f9 
  000060a0  90 02 80 d2 10 00 a0 f2  10 00 c0 f2 10 00 e0 f2 
  000060b0  ea 03 0b aa 4a 21 00 91  50 01 00 f9 f0 03 00 91 
  000060c0  10 82 04 91 f0 13 00 f9  f1 13 40 f9 50 01 80 d2 
  000060d0  10 00 a0 f2 10 00 c0 f2  10 00 e0 f2 e9 03 11 aa 
  000060e0  30 01 00 f9 90 02 80 d2  10 00 a0 f2 10 00 c0 f2 
  000060f0  10 00 e0 f2 e9 03 11 aa  29 21 00 91 30 01 00 f9 
  00006100  d0 03 80 d2 10 00 a0 f2  10 00 c0 f2 10 00 e0 f2 
  00006110  e9 03 11 aa 29 41 00 91  30 01 00 f9 10 05 80 d2 
  00006120  10 00 a0 f2 10 00 c0 f2  10 00 e0 f2 e9 03 11 aa 
  00006130  29 61 00 91 30 01 00 f9  f0 03 00 91 10 02 05 91 
  00006140  f0 1b 00 f9 f1 13 40 f9  e9 03 11 aa 30 01 40 f9 
  00006150  f0 7b 00 f9 e9 03 11 aa  29 21 00 91 30 01 40 f9 
  00006160  f0 7f 00 f9 e9 03 11 aa  29 41 00 91 30 01 40 f9 
  00006170  f0 83 00 f9 e9 03 11 aa  29 61 00 91 30 01 40 f9 
  00006180  f0 87 00 f9 f0 03 00 91  10 c2 03 91 f0 1f 00 f9 
  00006190  f1 1b 40 f9 f0 7b 40 f9  e9 03 11 aa 30 01 00 f9 
  000061a0  f0 7f 40 f9 e9 03 11 aa  29 21 00 91 30 01 00 f9 
  000061b0  f0 83 40 f9 e9 03 11 aa  29 41 00 91 30 01 00 f9 
  000061c0  f0 87 40 f9 e9 03 11 aa  29 61 00 91 30 01 00 f9 
  000061d0  f0 03 00 91 10 82 05 91  f0 27 00 f9 f1 27 40 f9 
  000061e0  f0 1b 40 f9 30 02 00 f9  f0 27 40 f9 11 02 40 f9 
  000061f0  f1 2f 00 f9 e0 2f 40 f9  35 ff ff 97 e0 33 00 f9 
  00006200  01 00 00 14 f0 0b 40 f9  f0 37 00 f9 f0 37 40 f9 
  00006210  11 02 40 f9 f1 3b 00 f9  00 00 00 90 00 00 00 91 
  00006220  00 60 00 91 e1 3b 40 f9  f0 3b 40 f9 f0 03 00 f9 
  00006230  e2 33 40 f9 f0 33 40 f9  f0 07 00 f9 00 00 00 94 
  00006240  bf 03 00 91 fd 7b 57 a9  ff 03 06 91 00 00 80 d2 
  00006250  c0 03 5f d6 

.rodata (38 bytes):
  00000000  00 00 00 45 4c 46 20 50  49 45 20 72 6f 64 61 74 
  00000010  61 20 63 68 65 63 6b 00  25 73 3a 20 73 75 6d 3d 
