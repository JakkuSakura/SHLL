fp-native dump: format=MachO arch=Aarch64 entry=0x6668
...
global __const_data_0 ty=Array(I8, 61) constant=true initializer=Some(Bytes([72, 84, 84, 80, 47, 49, 46, 49, 32, 50, 48, 48, 32, 79, 75, 13, 10, 67, 111, 110, 116, 101, 110, 116, 45, 76, 101, 110, 103, 116, 104, 58, 32, 51, 13, 10, 67, 111, 110, 110, 101, 99, 116, 105, 111, 110, 58, 32, 99, 108, 111, 115, 101, 13, 10, 13, 10, 79, 75, 10, 0]))
...
fn strlen
fn close
fn examples__39_async_http_server__make_addr
  bb0 bb0
...
fn main
  ...
  bb4 bb4
    ...
    br
  bb6 bb6
    call symbol(examples__39_async_http_server__make_addr)(31, 145) cc=C tail=false
    alloca Virtual { id: 51, bank: General, size_bits: 64 }, 1
  ...
  bb20 bb20
    br
  bb21 bb21
    call symbol(examples__39_async_http_server__make_addr)(0, 0) cc=C tail=false
    alloca Virtual { id: 83, bank: General, size_bits: 64 }, 1
  ...
  bb27 bb27
    alloca Virtual { id: 117, bank: General, size_bits: 64 }, 1
    store mem(AsmMemoryOperand { base: Some(Virtual { id: 117, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: None, address_space: None, pre_indexed: false, post_indexed: false }), symbol(__const_data_0)
    alloca Virtual { id: 119, bank: General, size_bits: 64 }, 1
    load Virtual { id: 120, bank: General, size_bits: 64 }, mem(AsmMemoryOperand { base: Some(Virtual { id: 117, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: Some(8), address_space: None, pre_indexed: false, post_indexed: false })
    ...
    load Virtual { id: 122, bank: General, size_bits: 64 }, mem(AsmMemoryOperand { base: Some(Virtual { id: 119, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: Some(8), address_space: None, pre_indexed: false, post_indexed: false })
    call symbol(strlen)(v122) cc=C tail=false
    br
  bb29 bb29
    alloca Virtual { id: 124, bank: General, size_bits: 64 }, 1
    store mem(AsmMemoryOperand { base: Some(Virtual { id: 124, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: None, address_space: None, pre_indexed: false, post_indexed: false }), symbol(__const_data_0)
    ...
    store mem(AsmMemoryOperand { base: Some(Virtual { id: 126, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: None, address_space: None, pre_indexed: false, post_indexed: false }), Virtual { id: 127, bank: General, size_bits: 64 }
    load Virtual { id: 129, bank: General, size_bits: 64 }, mem(AsmMemoryOperand { base: Some(Virtual { id: 126, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: Some(8), address_space: None, pre_indexed: false, post_indexed: false })
    call symbol(write)(v111, v129, v123) cc=C tail=false
    br
  bb30 bb30
...
Symbols:
  ...
  examples__39_async_http_server__make_addr 0x000062fc
  main                             0x00006668

Text relocations:
  offset=0x00006688 kind=CallRel32 symbol=socket addend=0
  offset=0x000067d4 kind=CallRel32 symbol=setsockopt addend=0
  offset=0x000068dc kind=CallRel32 symbol=bind addend=0
  offset=0x00006940 kind=CallRel32 symbol=close addend=0
  offset=0x00006974 kind=CallRel32 symbol=listen addend=0
  offset=0x000069d8 kind=CallRel32 symbol=close addend=0
  offset=0x00006a04 kind=Aarch64AdrpAdd symbol=fp_rodata_base addend=0
  offset=0x00006a10 kind=CallRel32 symbol=printf addend=0
  offset=0x00006ba4 kind=CallRel32 symbol=accept addend=0
  offset=0x00006c1c kind=Aarch64AdrpAdd symbol=__const_data_0 addend=0
  offset=0x00006c5c kind=CallRel32 symbol=strlen addend=0
  offset=0x00006c78 kind=Aarch64AdrpAdd symbol=__const_data_0 addend=0
  offset=0x00006cc0 kind=CallRel32 symbol=write addend=0
  offset=0x00006cd0 kind=CallRel32 symbol=close addend=0
...
.text (28012 bytes):
  ...
  000062f0  00 00 20 d4 c0 03 5f d6  c0 03 5f d6 ff 43 09 d1 
  00006300  f0 03 00 91 10 02 09 91  1d 7a 00 a9 fd 03 00 91 
  00006310  e0 87 00 f9 e1 a3 03 39  e2 c3 03 39 f0 03 00 91 
  00006320  10 82 08 91 f0 03 00 f9  f0 03 00 91 10 c2 08 91 
  00006330  f0 07 00 f9 10 02 80 d2  f1 1f 80 d2 11 00 a0 f2 
  00006340  11 00 c0 f2 11 00 e0 f2  10 02 11 8a f0 0b 00 f9 
  00006350  f1 07 40 f9 f0 43 c0 39  30 02 00 39 f0 03 00 91 
  00006360  10 e2 08 91 f0 13 00 f9  50 00 80 d2 f1 1f 80 d2 
  00006370  11 00 a0 f2 11 00 c0 f2  11 00 e0 f2 10 02 11 8a 
  00006380  f0 17 00 f9 f1 13 40 f9  f0 a3 c0 39 30 02 00 39 
  00006390  f0 07 40 f9 11 02 c0 39  f1 1f 00 f9 f0 13 40 f9 
  000063a0  11 02 c0 39 f1 23 00 f9  10 00 80 d2 f0 8b 00 f9 
  000063b0  f0 8f 00 f9 f0 e3 c0 39  f0 43 04 39 f0 03 00 91 
  000063c0  10 42 04 91 f0 27 00 f9  f0 8b 40 f9 f0 93 00 f9 
  000063d0  f0 8f 40 f9 f0 97 00 f9  f0 03 c1 39 f0 87 04 39 
  000063e0  f0 03 00 91 10 82 04 91  f0 2b 00 f9 f0 93 40 f9 
  000063f0  f0 9b 00 f9 f0 97 40 f9  f0 9f 00 f9 f0 a3 c3 39 
  00006400  f0 cb 04 39 f0 03 00 91  10 c2 04 91 f0 2f 00 f9 
  00006410  f0 9b 40 f9 f0 a3 00 f9  f0 9f 40 f9 f0 a7 00 f9 
  00006420  f0 c3 c3 39 f0 0f 05 39  f0 03 00 91 10 02 05 91 
  00006430  f0 33 00 f9 f0 a3 40 f9  f0 ab 00 f9 f0 a7 40 f9 
  00006440  f0 af 00 f9 10 00 80 d2  f0 53 05 39 f0 03 00 91 
  00006450  10 42 05 91 f0 37 00 f9  f0 ab 40 f9 f0 b3 00 f9 
  00006460  f0 af 40 f9 f0 b7 00 f9  10 00 80 d2 f0 97 05 39 
  00006470  f0 03 00 91 10 82 05 91  f0 3b 00 f9 f0 b3 40 f9 
  00006480  f0 bb 00 f9 f0 b7 40 f9  f0 bf 00 f9 10 00 80 d2 
  00006490  f0 db 05 39 f0 03 00 91  10 c2 05 91 f0 3f 00 f9 
  000064a0  f0 bb 40 f9 f0 c3 00 f9  f0 bf 40 f9 f0 c7 00 f9 
  000064b0  10 00 80 d2 f0 1f 06 39  f0 03 00 91 10 02 06 91 
  000064c0  f0 43 00 f9 f0 c3 40 f9  f0 cb 00 f9 f0 c7 40 f9 
  000064d0  f0 cf 00 f9 10 00 80 d2  f0 63 06 39 f0 03 00 91 
  000064e0  10 42 06 91 f0 47 00 f9  f0 cb 40 f9 f0 d3 00 f9 
  000064f0  f0 cf 40 f9 f0 d7 00 f9  10 00 80 d2 f0 a7 06 39 
  00006500  f0 03 00 91 10 82 06 91  f0 4b 00 f9 f0 d3 40 f9 
  00006510  f0 db 00 f9 f0 d7 40 f9  f0 df 00 f9 10 00 80 d2 
  00006520  f0 eb 06 39 f0 03 00 91  10 c2 06 91 f0 4f 00 f9 
  00006530  f0 db 40 f9 f0 e3 00 f9  f0 df 40 f9 f0 e7 00 f9 
  00006540  10 00 80 d2 f0 2f 07 39  f0 03 00 91 10 02 07 91 
  00006550  f0 53 00 f9 f0 e3 40 f9  f0 eb 00 f9 f0 e7 40 f9 
  00006560  f0 ef 00 f9 10 00 80 d2  f0 73 07 39 f0 03 00 91 
  00006570  10 42 07 91 f0 57 00 f9  f0 eb 40 f9 f0 f3 00 f9 
  00006580  f0 ef 40 f9 f0 f7 00 f9  10 00 80 d2 f0 b7 07 39 
  00006590  f0 03 00 91 10 82 07 91  f0 5b 00 f9 f0 f3 40 f9 
  000065a0  f0 fb 00 f9 f0 f7 40 f9  f0 ff 00 f9 10 00 80 d2 
  000065b0  f0 fb 07 39 f0 03 00 91  10 c2 07 91 f0 5f 00 f9 
  000065c0  f0 fb 40 f9 f0 03 01 f9  f0 ff 40 f9 f0 07 01 f9 
  000065d0  10 00 80 d2 f0 3f 08 39  f0 03 00 91 10 02 08 91 
  000065e0  f0 63 00 f9 f1 03 40 f9  f0 03 41 f9 e9 03 11 aa 
  000065f0  30 01 00 f9 f0 07 41 f9  e9 03 11 aa 29 21 00 91 
  00006600  30 01 00 f9 f1 03 40 f9  e9 03 11 aa 30 01 40 f9 
  00006610  f0 0b 01 f9 e9 03 11 aa  29 21 00 91 30 01 40 f9 
  00006620  f0 0f 01 f9 f0 03 00 91  10 42 08 91 f0 6b 00 f9 
  00006630  f1 87 40 f9 f0 0b 41 f9  e9 03 11 aa 30 01 00 f9 
  00006640  f0 0f 41 f9 e9 03 11 aa  29 21 00 91 30 01 00 f9 
  00006650  bf 03 00 91 f0 03 00 91  10 02 09 91 1d 7a 40 a9 
  00006660  ff 43 09 91 c0 03 5f d6  ff c3 16 d1 f0 03 00 91 
  00006670  10 82 16 91 1d 7a 00 a9  fd 03 00 91 40 00 80 d2 
  00006680  21 00 80 d2 02 00 80 d2  00 00 00 94 e0 03 00 f9 
  00006690  01 00 00 14 f0 03 00 91  10 e2 12 91 f0 07 00 f9 
  000066a0  f0 03 80 b9 1f 02 00 f1  f0 a7 9f 9a f0 0b 00 f9 
  000066b0  f1 07 40 f9 f0 43 40 39  30 02 00 39 f0 07 40 f9 
  000066c0  11 02 40 39 f1 13 00 f9  f0 83 40 39 1f 06 00 f1 
  000066d0  f0 17 9f 9a f0 17 00 f9  f0 17 40 f9 1f 02 00 f1 
  000066e0  41 00 00 54 08 00 00 14  bf 03 00 91 f0 03 00 91 
  000066f0  10 82 16 91 1d 7a 40 a9  ff c3 16 91 00 00 80 d2 
  00006700  c0 03 5f d6 01 00 00 14  f0 03 00 91 10 02 13 91 
  00006710  f0 1b 00 f9 f1 1b 40 f9  30 00 80 d2 30 02 00 b9 
  00006720  f0 03 00 91 10 22 13 91  f0 23 00 f9 f1 23 40 f9 
  00006730  f0 1b 40 f9 30 02 00 f9  f0 03 00 91 10 42 13 91 
  00006740  f0 2b 00 f9 f0 23 40 f9  11 02 40 f9 f1 2f 00 f9 
  00006750  f0 2f 40 f9 f0 33 00 f9  f1 2b 40 f9 f0 33 40 f9 
  00006760  30 02 00 f9 f0 03 00 91  10 62 13 91 f0 3b 00 f9 
  00006770  f0 2b 40 f9 11 02 40 f9  f1 3f 00 f9 f1 3b 40 f9 
  00006780  f0 3f 40 f9 30 02 00 f9  f0 03 00 91 10 82 13 91 
  00006790  f0 47 00 f9 f0 3b 40 f9  11 02 40 f9 f1 4b 00 f9 
  000067a0  f0 4b 40 f9 f0 4f 00 f9  f1 47 40 f9 f0 4f 40 f9 
  000067b0  30 02 00 f9 f0 47 40 f9  11 02 40 f9 f1 57 00 f9 
  000067c0  e0 03 80 b9 21 00 80 d2  42 00 80 d2 e3 57 40 f9 
  000067d0  84 00 80 d2 00 00 00 94  e0 5b 00 f9 01 00 00 14 
  000067e0  e0 03 00 91 00 60 12 91  e1 03 80 d2 22 12 80 d2 
  000067f0  c3 fe ff 97 f0 03 00 91  10 62 12 91 f0 5f 00 f9 
  00006800  f0 03 00 91 10 a2 13 91  f0 63 00 f9 f1 63 40 f9 
  00006810  f0 4f 42 f9 e9 03 11 aa  30 01 00 f9 f0 53 42 f9 
  00006820  e9 03 11 aa 29 21 00 91  30 01 00 f9 01 00 00 14 
  00006830  f0 03 00 91 10 e2 13 91  f0 6b 00 f9 f1 6b 40 f9 
  00006840  f0 63 40 f9 30 02 00 f9  f0 03 00 91 10 02 14 91 
  00006850  f0 73 00 f9 f0 6b 40 f9  11 02 40 f9 f1 77 00 f9 
  00006860  f0 77 40 f9 f0 7b 00 f9  f1 73 40 f9 f0 7b 40 f9 
  00006870  30 02 00 f9 f0 03 00 91  10 22 14 91 f0 83 00 f9 
  00006880  f0 73 40 f9 11 02 40 f9  f1 87 00 f9 f1 83 40 f9 
  00006890  f0 87 40 f9 30 02 00 f9  f0 03 00 91 10 42 14 91 
  000068a0  f0 8f 00 f9 f0 83 40 f9  11 02 40 f9 f1 93 00 f9 
  000068b0  f0 93 40 f9 f0 97 00 f9  f1 8f 40 f9 f0 97 40 f9 
  000068c0  30 02 00 f9 f0 8f 40 f9  11 02 40 f9 f1 9f 00 f9 
  000068d0  e0 03 80 b9 e1 9f 40 f9  02 02 80 d2 00 00 00 94 
  000068e0  e0 a3 00 f9 01 00 00 14  f0 03 00 91 10 62 14 91 
  000068f0  f0 a7 00 f9 f0 43 81 b9  1f 02 00 f1 f0 07 9f 9a 
  00006900  f0 ab 00 f9 f1 a7 40 f9  f0 43 45 39 30 02 00 39 
  00006910  f0 a7 40 f9 11 02 40 39  f1 b3 00 f9 f0 83 45 39 
  00006920  1f 06 00 f1 f0 17 9f 9a  f0 b7 00 f9 f0 b7 40 f9 
  00006930  1f 02 00 f1 41 00 00 54  05 00 00 14 e0 03 80 b9 
  00006940  00 00 00 94 e0 bb 00 f9  02 00 00 14 08 00 00 14 
  00006950  bf 03 00 91 f0 03 00 91  10 82 16 91 1d 7a 40 a9 
  00006960  ff c3 16 91 00 00 80 d2  c0 03 5f d6 e0 03 80 b9 
  00006970  01 10 80 d2 00 00 00 94  e0 bf 00 f9 01 00 00 14 
  00006980  f0 03 00 91 10 82 14 91  f0 c3 00 f9 f0 7b 81 b9 
  00006990  1f 02 00 f1 f0 07 9f 9a  f0 c7 00 f9 f1 c3 40 f9 
  000069a0  f0 23 46 39 30 02 00 39  f0 c3 40 f9 11 02 40 39 
  000069b0  f1 cf 00 f9 f0 63 46 39  1f 06 00 f1 f0 17 9f 9a 
  000069c0  f0 d3 00 f9 f0 d3 40 f9  1f 02 00 f1 41 00 00 54 
  000069d0  05 00 00 14 e0 03 80 b9  00 00 00 94 e0 d7 00 f9 
  000069e0  02 00 00 14 08 00 00 14  bf 03 00 91 f0 03 00 91 
  000069f0  10 82 16 91 1d 7a 40 a9  ff c3 16 91 00 00 80 d2 
  00006a00  c0 03 5f d6 00 00 00 90  00 00 00 91 00 60 01 91 
  00006a10  00 00 00 94 01 00 00 14  01 00 00 14 e0 03 00 91 
  00006a20  00 a0 12 91 01 00 80 d2  02 00 80 d2 34 fe ff 97 
  00006a30  f0 03 00 91 10 a2 12 91  f0 df 00 f9 f0 03 00 91 
  00006a40  10 a2 14 91 f0 e3 00 f9  f1 e3 40 f9 f0 57 42 f9 
  00006a50  e9 03 11 aa 30 01 00 f9  f0 5b 42 f9 e9 03 11 aa 
  00006a60  29 21 00 91 30 01 00 f9  01 00 00 14 f0 03 00 91 
  00006a70  10 e2 14 91 f0 eb 00 f9  f1 eb 40 f9 10 02 80 d2 
  00006a80  30 02 00 b9 f0 03 00 91  10 02 15 91 f0 f3 00 f9 
  00006a90  f1 f3 40 f9 f0 e3 40 f9  30 02 00 f9 f0 03 00 91 
  00006aa0  10 22 15 91 f0 fb 00 f9  f0 f3 40 f9 11 02 40 f9 
  00006ab0  f1 ff 00 f9 f0 ff 40 f9  f0 03 01 f9 f1 fb 40 f9 
  00006ac0  f0 03 41 f9 30 02 00 f9  f0 03 00 91 10 42 15 91 
  00006ad0  f0 0b 01 f9 f0 fb 40 f9  11 02 40 f9 f1 0f 01 f9 
  00006ae0  f1 0b 41 f9 f0 0f 41 f9  30 02 00 f9 f0 03 00 91 
  00006af0  10 62 15 91 f0 17 01 f9  f1 17 41 f9 f0 eb 40 f9 
  00006b00  30 02 00 f9 f0 03 00 91  10 82 15 91 f0 1f 01 f9 
  00006b10  f0 17 41 f9 11 02 40 f9  f1 23 01 f9 f0 23 41 f9 
  00006b20  f0 27 01 f9 f1 1f 41 f9  f0 27 41 f9 30 02 00 f9 
  00006b30  f0 03 00 91 10 a2 15 91  f0 2f 01 f9 f0 1f 41 f9 
  00006b40  11 02 40 f9 f1 33 01 f9  f1 2f 41 f9 f0 33 41 f9 
  00006b50  30 02 00 f9 f0 03 00 91  10 c2 15 91 f0 3b 01 f9 
  00006b60  f0 0b 41 f9 11 02 40 f9  f1 3f 01 f9 f0 3f 41 f9 
  00006b70  f0 43 01 f9 f1 3b 41 f9  f0 43 41 f9 30 02 00 f9 
  00006b80  f0 3b 41 f9 11 02 40 f9  f1 4b 01 f9 f0 2f 41 f9 
  00006b90  11 02 40 f9 f1 4f 01 f9  e0 03 80 b9 e1 4b 41 f9 
  00006ba0  e2 4f 41 f9 00 00 00 94  e0 53 01 f9 01 00 00 14 
  00006bb0  f0 03 00 91 10 e2 15 91  f0 57 01 f9 f0 a3 82 b9 
  00006bc0  1f 02 00 f1 f0 a7 9f 9a  f0 5b 01 f9 f1 57 41 f9 
  00006bd0  f0 c3 4a 39 30 02 00 39  f0 57 41 f9 11 02 40 39 
  00006be0  f1 63 01 f9 f0 03 4b 39  1f 06 00 f1 f0 17 9f 9a 
  00006bf0  f0 67 01 f9 f0 67 41 f9  1f 02 00 f1 41 00 00 54 
  00006c00  02 00 00 14 85 ff ff 17  01 00 00 14 f0 03 00 91 
  00006c10  10 02 16 91 f0 6b 01 f9  f1 6b 41 f9 10 00 00 90 
  00006c20  10 02 00 91 30 02 00 f9  f0 03 00 91 10 22 16 91 
  00006c30  f0 73 01 f9 f0 6b 41 f9  11 02 40 f9 f1 77 01 f9 
  00006c40  f1 73 41 f9 f0 77 41 f9  30 02 00 f9 f0 73 41 f9 
  00006c50  11 02 40 f9 f1 7f 01 f9  e0 7f 41 f9 00 00 00 94 
  00006c60  e0 83 01 f9 01 00 00 14  f0 03 00 91 10 42 16 91 
  00006c70  f0 87 01 f9 f1 87 41 f9  10 00 00 90 10 02 00 91 
  00006c80  30 02 00 f9 f0 03 00 91  10 62 16 91 f0 8f 01 f9 
  00006c90  f0 87 41 f9 11 02 40 f9  f1 93 01 f9 f1 8f 41 f9 
  00006ca0  f0 93 41 f9 30 02 00 f9  f0 8f 41 f9 11 02 40 f9 
  00006cb0  f1 9b 01 f9 e0 a3 82 b9  e1 9b 41 f9 e2 83 41 f9 
  00006cc0  00 00 00 94 e0 9f 01 f9  01 00 00 14 e0 a3 82 b9 
  00006cd0  00 00 00 94 e0 a3 01 f9  01 00 00 14 4f ff ff 17 
  00006ce0  bf 03 00 91 f0 03 00 91  10 82 16 91 1d 7a 40 a9 
  00006cf0  ff c3 16 91 00 00 80 d2  c0 03 5f d6 bf 03 00 91 
  00006d00  f0 03 00 91 10 82 16 91  1d 7a 40 a9 ff c3 16 91 
  00006d10  00 00 80 d2 c0 03 5f d6  bf 03 00 91 f0 03 00 91 
  00006d20  10 82 16 91 1d 7a 40 a9  ff c3 16 91 00 00 80 d2 
  00006d30  c0 03 5f d6 bf 03 00 91  f0 03 00 91 10 82 16 91 
  00006d40  1d 7a 40 a9 ff c3 16 91  00 00 80 d2 c0 03 5f d6 
  00006d50  bf 03 00 91 f0 03 00 91  10 82 16 91 1d 7a 40 a9 
  00006d60  ff c3 16 91 00 00 80 d2  c0 03 5f d6 
...
.rodata (117 bytes):
  ...
  00000030  2d 4c 65 6e 67 74 68 3a  20 33 0d 0a 43 6f 6e 6e 
  00000040  65 63 74 69 6f 6e 3a 20  63 6c 6f 73 65 0d 0a 0d 
  00000050  0a 4f 4b 0a 00 00 00 00  6c 69 73 74 65 6e 69 6e 
