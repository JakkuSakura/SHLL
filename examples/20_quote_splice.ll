...
bb0:
  ...
  %alloca_102 = alloca i32, align 4
  %alloca_count_102 = alloca i32, align 4
  %alloca_100 = alloca i32, align 4
  %alloca_count_100 = alloca i32, align 4
  store i32 %0, ptr %alloca_count_100, align 4
  %load_103 = load i32, ptr %alloca_count_100, align 4
  %zext = zext i32 %load_103 to i64
  %iop_104 = add i64 %zext, 1
  store i64 %iop_104, ptr %alloca_count_100, align 4
  %load_106 = load i32, ptr %alloca_count_100, align 4
  %call_107 = call i32 (ptr, ...) @printf(ptr @.str.20_quote_splice.10, i64 0, i32 %load_106)
  br label %bb1

bb1:                                              ; preds = %bb0
  %load_109 = load i32, ptr %alloca_count_100, align 4
...
bb2:                                              ; preds = %bb1
  %load_113 = load i32, ptr %alloca_count_100, align 4
  store i32 %load_113, ptr %alloca_count_102, align 4
  %load_115 = load i32, ptr %alloca_count_102, align 4
  ret i32 %load_115
...
bb4:                                              ; preds = %bb5, %bb3
  %load_116 = load i32, ptr %alloca_count_100, align 4
  %zext3 = zext i32 %load_116 to i64
  %iop_117 = add i64 %zext3, 2
  store i64 %iop_117, ptr %alloca_count_100, align 4
  %load_119 = load i32, ptr %alloca_count_100, align 4
  %call_120 = call i32 (ptr, ...) @printf(ptr @.str.20_quote_splice.10, i64 1, i32 %load_119)
  br label %bb6

bb6:                                              ; preds = %bb4
  %load_122 = load i32, ptr %alloca_count_100, align 4
...
bb7:                                              ; preds = %bb6
  %load_126 = load i32, ptr %alloca_count_100, align 4
  store i32 %load_126, ptr %alloca_count_102, align 4
  %load_128 = load i32, ptr %alloca_count_102, align 4
  ret i32 %load_128
...
bb9:                                              ; preds = %bb10, %bb8
  %load_129 = load i32, ptr %alloca_count_100, align 4
  %zext6 = zext i32 %load_129 to i64
  %iop_130 = add i64 %zext6, 3
  store i64 %iop_130, ptr %alloca_count_100, align 4
  %load_132 = load i32, ptr %alloca_count_100, align 4
  %call_133 = call i32 (ptr, ...) @printf(ptr @.str.20_quote_splice.10, i64 2, i32 %load_132)
  br label %bb11

bb11:                                             ; preds = %bb9
  %load_135 = load i32, ptr %alloca_count_100, align 4
...
bb12:                                             ; preds = %bb11
  %load_139 = load i32, ptr %alloca_count_100, align 4
  store i32 %load_139, ptr %alloca_count_102, align 4
  %load_141 = load i32, ptr %alloca_count_102, align 4
  ret i32 %load_141
...
bb14:                                             ; preds = %bb15, %bb13
  %load_142 = load i32, ptr %alloca_count_100, align 4
  %zext9 = zext i32 %load_142 to i64
  %iop_143 = add i64 %zext9, 4
  store i64 %iop_143, ptr %alloca_count_100, align 4
  %load_145 = load i32, ptr %alloca_count_100, align 4
  %call_146 = call i32 (ptr, ...) @printf(ptr @.str.20_quote_splice.10, i64 3, i32 %load_145)
  br label %bb16

bb16:                                             ; preds = %bb14
  %load_148 = load i32, ptr %alloca_count_100, align 4
...
bb17:                                             ; preds = %bb16
  %load_152 = load i32, ptr %alloca_count_100, align 4
  store i32 %load_152, ptr %alloca_count_102, align 4
  %load_154 = load i32, ptr %alloca_count_102, align 4
  ret i32 %load_154
...
bb19:                                             ; preds = %bb20, %bb18
  %load_155 = load i32, ptr %alloca_count_100, align 4
  store i32 %load_155, ptr %alloca_count_102, align 4
  %load_157 = load i32, ptr %alloca_count_102, align 4
  ret i32 %load_157
...
bb0:
  ...
  %alloca_159 = alloca i32, align 4
  %alloca_count_159 = alloca i32, align 4
  %alloca_158 = alloca i32, align 4
  %alloca_count_158 = alloca i32, align 4
  store i32 %0, ptr %alloca_count_159, align 4
  %load_161 = load i32, ptr %alloca_count_159, align 4
  %zext = zext i32 %load_161 to i64
  %iop_162 = add i64 %zext, 5
  store i64 %iop_162, ptr %alloca_count_159, align 4
  %load_164 = load i32, ptr %alloca_count_159, align 4
  %call_165 = call i32 (ptr, ...) @printf(ptr @.str.20_quote_splice.10, i64 0, i32 %load_164)
  br label %bb1

bb1:                                              ; preds = %bb0
  %load_167 = load i32, ptr %alloca_count_159, align 4
...
bb2:                                              ; preds = %bb1
  %load_171 = load i32, ptr %alloca_count_159, align 4
  store i32 %load_171, ptr %alloca_count_158, align 4
  %load_173 = load i32, ptr %alloca_count_158, align 4
  ret i32 %load_173
...
bb4:                                              ; preds = %bb5, %bb3
  %load_174 = load i32, ptr %alloca_count_159, align 4
  %zext3 = zext i32 %load_174 to i64
  %iop_175 = add i64 %zext3, -2
  store i64 %iop_175, ptr %alloca_count_159, align 4
  %load_177 = load i32, ptr %alloca_count_159, align 4
  %call_178 = call i32 (ptr, ...) @printf(ptr @.str.20_quote_splice.10, i64 1, i32 %load_177)
  br label %bb6

bb6:                                              ; preds = %bb4
  %load_180 = load i32, ptr %alloca_count_159, align 4
...
bb7:                                              ; preds = %bb6
  %load_184 = load i32, ptr %alloca_count_159, align 4
  store i32 %load_184, ptr %alloca_count_158, align 4
  %load_186 = load i32, ptr %alloca_count_158, align 4
  ret i32 %load_186
...
bb9:                                              ; preds = %bb10, %bb8
  %load_187 = load i32, ptr %alloca_count_159, align 4
  %zext6 = zext i32 %load_187 to i64
  %iop_188 = add i64 %zext6, 7
  store i64 %iop_188, ptr %alloca_count_159, align 4
  %load_190 = load i32, ptr %alloca_count_159, align 4
  %call_191 = call i32 (ptr, ...) @printf(ptr @.str.20_quote_splice.10, i64 2, i32 %load_190)
  br label %bb11

bb11:                                             ; preds = %bb9
  %load_193 = load i32, ptr %alloca_count_159, align 4
...
bb12:                                             ; preds = %bb11
  %load_197 = load i32, ptr %alloca_count_159, align 4
  store i32 %load_197, ptr %alloca_count_158, align 4
  %load_199 = load i32, ptr %alloca_count_158, align 4
  ret i32 %load_199
...
bb14:                                             ; preds = %bb15, %bb13
  %load_200 = load i32, ptr %alloca_count_159, align 4
  store i32 %load_200, ptr %alloca_count_158, align 4
  %load_202 = load i32, ptr %alloca_count_158, align 4
  ret i32 %load_202
