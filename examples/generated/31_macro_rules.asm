...
fn main
  bb0 bb0
    ...
    add Virtual { id: 1, bank: General, size_bits: 64 }, 10, 32
    ...
    call symbol(_31_macro_rules__add_two)(5, 5) cc=C tail=false
    br
  bb1 bb1
    ...
    ret
fn _31_macro_rules__add_two
  bb0 bb0
    alloca Virtual { id: 9, bank: General, size_bits: 64 }, 8
    add Virtual { id: 10, bank: General, size_bits: 64 }, symbol(local.1), 2
...
Symbols:
  main                             0x00000000
  _31_macro_rules__add_two         0x000000b0
...
.text (264 bytes):
  ...
  00000050  f0 1b 40 f9 30 02 00 f9  a0 00 80 d2 a1 00 80 d2 
  00000060  14 00 00 94 e0 23 00 f9  01 00 00 14 f0 17 40 f9 
  00000070  11 02 40 f9 f1 27 00 f9  00 00 00 90 00 00 00 91 
  00000080  e1 27 40 f9 f0 27 40 f9  f0 03 00 f9 e2 23 40 f9 
  00000090  f0 23 40 f9 f0 07 00 f9  00 00 00 94 bf 03 00 91 
  000000a0  fd 7b 52 a9 ff c3 04 91  00 00 80 d2 c0 03 5f d6 
  000000b0  ff c3 02 d1 fd 7b 0a a9  fd 03 00 91 e0 2f 00 f9 
  000000c0  1f 20 03 d5 f0 03 00 91  10 82 01 91 f0 1b 00 f9 
  000000d0  f0 2f 40 f9 10 0a 00 91  f0 1f 00 f9 f1 1b 40 f9 
  000000e0  f0 1f 40 f9 30 02 00 f9  f0 1b 40 f9 11 02 40 f9 
  000000f0  f1 27 00 f9 e0 27 40 f9  bf 03 00 91 fd 7b 4a a9 
  00000100  ff c3 02 91 c0 03 5f d6 
