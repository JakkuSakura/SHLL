...
Symbols:
  examples__39_async_http_server__make_addr 0x00000000
  main                             0x0000036c
...
.rodata (117 bytes):
  ...
  00000030  67 74 68 3a 20 33 0d 0a  43 6f 6e 6e 65 63 74 69 
  00000040  6f 6e 3a 20 63 6c 6f 73  65 0d 0a 0d 0a 4f 4b 0a 
  00000050  00 00 00 00 00 00 00 00  6c 69 73 74 65 6e 69 6e 
