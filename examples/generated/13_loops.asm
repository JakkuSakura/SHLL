...
fn main
  ...
  bb6 bb6
    ...
    condbr
  bb7 bb7
    load Virtual { id: 136, bank: General, size_bits: 64 }, mem(AsmMemoryOperand { base: Some(Virtual { id: 92, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: Some(8), address_space: None, pre_indexed: false, post_indexed: false })
    ...
    store mem(AsmMemoryOperand { base: Some(Virtual { id: 92, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: None, address_space: None, pre_indexed: false, post_indexed: false }), Virtual { id: 138, bank: General, size_bits: 64 }
    ...
    br
  bb8 bb8
    load Virtual { id: 143, bank: General, size_bits: 64 }, mem(AsmMemoryOperand { base: Some(Virtual { id: 92, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: Some(8), address_space: None, pre_indexed: false, post_indexed: false })
  ...
  bb12 bb12
    ...
    load Virtual { id: 157, bank: General, size_bits: 64 }, mem(AsmMemoryOperand { base: Some(Virtual { id: 97, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: Some(8), address_space: None, pre_indexed: false, post_indexed: false })
  ...
  bb16 bb16
    ...
    load Virtual { id: 178, bank: General, size_bits: 64 }, mem(AsmMemoryOperand { base: Some(Virtual { id: 97, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: Some(8), address_space: None, pre_indexed: false, post_indexed: false })
    ...
    condbr
  bb17 bb17
    load Virtual { id: 184, bank: General, size_bits: 64 }, mem(AsmMemoryOperand { base: Some(Virtual { id: 97, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: Some(8), address_space: None, pre_indexed: false, post_indexed: false })
    add Virtual { id: 185, bank: General, size_bits: 64 }, Virtual { id: 184, bank: General, size_bits: 64 }, 1
    store mem(AsmMemoryOperand { base: Some(Virtual { id: 97, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: None, address_space: None, pre_indexed: false, post_indexed: false }), Virtual { id: 185, bank: General, size_bits: 64 }
    br
  bb18 bb18
    load Virtual { id: 187, bank: General, size_bits: 64 }, mem(AsmMemoryOperand { base: Some(Virtual { id: 97, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: Some(8), address_space: None, pre_indexed: false, post_indexed: false })
...
.text (3136 bytes):
  ...
  00000400  30 02 00 f9 f1 03 40 f9  10 00 80 d2 30 02 00 f9 
  00000410  01 00 00 14 f0 03 00 91  10 42 05 91 f0 17 00 f9 
  00000420  f0 03 40 f9 11 02 40 f9  f1 1b 00 f9 f0 1b 40 f9 
  ...
  00000470  41 00 00 54 30 00 00 14  f0 03 40 f9 11 02 40 f9 
  00000480  f1 2f 00 f9 f0 2f 40 f9  10 06 00 91 f0 33 00 f9 
  00000490  f1 03 40 f9 f0 33 40 f9  30 02 00 f9 f0 03 00 91 
  000004a0  10 62 05 91 f0 3b 00 f9  f0 03 40 f9 11 02 40 f9 
  ...
  00000540  f1 0b 40 f9 f0 63 40 f9  30 02 00 f9 f0 0b 40 f9 
  ...
  00000580  f0 03 40 f9 11 02 40 f9  f1 73 00 f9 f0 6f 40 f9 
  00000590  f1 73 40 f9 10 02 11 8b  f0 77 00 f9 f1 07 40 f9 
  000005a0  f0 77 40 f9 30 02 00 f9  9b ff ff 17 f0 0b 40 f9 
  ...
  00000700  00 00 00 91 00 80 04 91  00 00 00 94 f1 1b 40 f9 
  ...
  00000780  41 00 00 54 18 00 00 14  f0 1b 40 f9 11 02 40 f9 
  00000790  f1 77 00 f9 f0 23 40 f9  11 02 40 f9 f1 7b 00 f9 
  000007a0  f0 77 40 f9 f1 7b 40 f9  10 02 11 8b f0 7f 00 f9 
  000007b0  f1 1b 40 f9 f0 7f 40 f9  30 02 00 f9 f0 23 40 f9 
  000007c0  11 02 40 f9 f1 87 00 f9  f0 87 40 f9 10 06 00 91 
  000007d0  f0 8b 00 f9 f1 23 40 f9  f0 8b 40 f9 30 02 00 f9 
  000007e0  d2 ff ff 17 f0 1b 40 f9  11 02 40 f9 f1 93 00 f9 
  000007f0  00 00 00 90 00 00 00 91  00 00 05 91 e1 93 40 f9 
  00000800  f0 93 40 f9 f0 03 00 f9  00 00 00 94 f1 0b 40 f9 
  00000810  10 00 80 d2 30 02 00 f9  f1 0f 40 f9 b0 00 80 d2 
  00000820  30 02 00 f9 01 00 00 14  f0 03 00 91 10 e2 12 91 
  00000830  f0 a3 00 f9 f0 0f 40 f9  11 02 40 f9 f1 a7 00 f9 
  ...
  00000880  41 00 00 54 18 00 00 14  f0 0b 40 f9 11 02 40 f9 
  00000890  f1 bb 00 f9 f0 0f 40 f9  11 02 40 f9 f1 bf 00 f9 
  000008a0  f0 bb 40 f9 f1 bf 40 f9  10 02 11 8b f0 c3 00 f9 
  000008b0  f1 0b 40 f9 f0 c3 40 f9  30 02 00 f9 f0 0f 40 f9 
  000008c0  11 02 40 f9 f1 cb 00 f9  f0 cb 40 f9 10 06 00 91 
  000008d0  f0 cf 00 f9 f1 0f 40 f9  f0 cf 40 f9 30 02 00 f9 
  000008e0  d2 ff ff 17 f0 0b 40 f9  11 02 40 f9 f1 d7 00 f9 
  ...
  000009c0  f1 17 40 f9 10 00 80 d2  30 02 00 f9 f1 1f 40 f9 
  000009d0  30 00 80 d2 30 02 00 f9  01 00 00 14 f0 03 00 91 
  000009e0  10 02 13 91 f0 0b 01 f9  f0 1f 40 f9 11 02 40 f9 
  ...
  00000b50  f0 03 00 91 10 42 13 91  f0 5f 01 f9 f0 1f 40 f9 
  ...
  00000bc0  f0 1f 40 f9 11 02 40 f9  f1 7b 01 f9 f0 7b 41 f9 
  00000bd0  10 06 00 91 f0 7f 01 f9  f1 1f 40 f9 f0 7f 41 f9 
  00000be0  30 02 00 f9 7e ff ff 17  f0 1f 40 f9 11 02 40 f9 
