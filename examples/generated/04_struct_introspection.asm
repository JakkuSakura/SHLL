...
fn main
  bb0 bb0
    ...
    intrinsic.call symbol(intrinsic.println)
    intrinsic.call symbol(intrinsic.println), symbol(__fp_const_04_struct_introspection_12)
    intrinsic.call symbol(intrinsic.println), symbol(__fp_const_04_struct_introspection_13)
    intrinsic.call symbol(intrinsic.println), symbol(__fp_const_04_struct_introspection_14)
    intrinsic.call symbol(intrinsic.println)
    bitcast Virtual { id: 94, bank: General, size_bits: 64 }, Virtual { id: 85, bank: General, size_bits: 64 }
    load Virtual { id: 95, bank: Float, size_bits: 64 }, mem(AsmMemoryOperand { base: Some(Virtual { id: 94, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: Some(8), address_space: None, pre_indexed: false, post_indexed: false })
    bitcast Virtual { id: 96, bank: General, size_bits: 64 }, Virtual { id: 85, bank: General, size_bits: 64 }
    gep Virtual { id: 97, bank: General, size_bits: 64 }, Virtual { id: 96, bank: General, size_bits: 64 }, 8
    bitcast Virtual { id: 98, bank: General, size_bits: 64 }, Virtual { id: 97, bank: General, size_bits: 64 }
    load Virtual { id: 99, bank: Float, size_bits: 64 }, mem(AsmMemoryOperand { base: Some(Virtual { id: 98, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: Some(8), address_space: None, pre_indexed: false, post_indexed: false })
    intrinsic.call symbol(intrinsic.println), Virtual { id: 95, bank: Float, size_bits: 64 }, Virtual { id: 99, bank: Float, size_bits: 64 }
    bitcast Virtual { id: 101, bank: General, size_bits: 64 }, Virtual { id: 87, bank: General, size_bits: 64 }
    load Virtual { id: 102, bank: General, size_bits: 8 }, mem(AsmMemoryOperand { base: Some(Virtual { id: 101, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: Some(1), address_space: None, pre_indexed: false, post_indexed: false })
    bitcast Virtual { id: 103, bank: General, size_bits: 64 }, Virtual { id: 87, bank: General, size_bits: 64 }
    gep Virtual { id: 104, bank: General, size_bits: 64 }, Virtual { id: 103, bank: General, size_bits: 64 }, 1
    bitcast Virtual { id: 105, bank: General, size_bits: 64 }, Virtual { id: 104, bank: General, size_bits: 64 }
    load Virtual { id: 106, bank: General, size_bits: 8 }, mem(AsmMemoryOperand { base: Some(Virtual { id: 105, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: Some(1), address_space: None, pre_indexed: false, post_indexed: false })
    bitcast Virtual { id: 107, bank: General, size_bits: 64 }, Virtual { id: 87, bank: General, size_bits: 64 }
    gep Virtual { id: 108, bank: General, size_bits: 64 }, Virtual { id: 107, bank: General, size_bits: 64 }, 2
    bitcast Virtual { id: 109, bank: General, size_bits: 64 }, Virtual { id: 108, bank: General, size_bits: 64 }
    load Virtual { id: 110, bank: General, size_bits: 8 }, mem(AsmMemoryOperand { base: Some(Virtual { id: 109, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: Some(1), address_space: None, pre_indexed: false, post_indexed: false })
    intrinsic.call symbol(intrinsic.println), Virtual { id: 102, bank: General, size_bits: 8 }, Virtual { id: 106, bank: General, size_bits: 8 }, Virtual { id: 110, bank: General, size_bits: 8 }
    intrinsic.call symbol(intrinsic.println)
    ret
...
Text relocations:
  ...
  offset=0x000001f0 kind=Aarch64AdrpAdd symbol=fp_rodata_base addend=0
  offset=0x000001fc kind=Aarch64GotLoad symbol=__fp_const_04_struct_introspection_12 addend=0
  offset=0x00000204 kind=Aarch64GotLoad symbol=__fp_const_04_struct_introspection_12 addend=0
  offset=0x00000210 kind=CallRel32 symbol=printf addend=0
  offset=0x00000214 kind=Aarch64AdrpAdd symbol=fp_rodata_base addend=0
  offset=0x00000220 kind=Aarch64GotLoad symbol=__fp_const_04_struct_introspection_13 addend=0
  offset=0x00000228 kind=Aarch64GotLoad symbol=__fp_const_04_struct_introspection_13 addend=0
  offset=0x00000234 kind=CallRel32 symbol=printf addend=0
  offset=0x00000238 kind=Aarch64AdrpAdd symbol=fp_rodata_base addend=0
  offset=0x00000244 kind=Aarch64GotLoad symbol=__fp_const_04_struct_introspection_14 addend=0
  offset=0x0000024c kind=Aarch64GotLoad symbol=__fp_const_04_struct_introspection_14 addend=0
  ...
  offset=0x00000268 kind=CallRel32 symbol=printf addend=0
  offset=0x000002ac kind=Aarch64AdrpAdd symbol=fp_rodata_base addend=0
  offset=0x000002d0 kind=CallRel32 symbol=printf addend=0
  ...
  offset=0x00000374 kind=Aarch64AdrpAdd symbol=fp_rodata_base addend=0
  offset=0x00000380 kind=CallRel32 symbol=printf addend=0

.text (928 bytes):
  00000000  ff 03 0e d1 f0 03 00 91  10 c2 0d 91 1d 7a 00 a9 
  ...
  000001c0  10 82 0d 91 f0 5b 00 f9  f0 1f 80 d2 10 00 a0 f2 
  000001d0  10 00 c0 f2 10 00 e0 f2  f1 5b 40 f9 30 02 00 f9 
  000001e0  00 00 00 90 00 00 00 91  00 80 07 91 00 00 00 94 
  000001f0  00 00 00 90 00 00 00 91  00 00 08 91 01 00 00 90 
  00000200  21 00 40 f9 10 00 00 90  10 02 40 f9 f0 03 00 f9 
  00000210  00 00 00 94 00 00 00 90  00 00 00 91 00 80 08 91 
  00000220  01 00 00 90 21 00 40 f9  10 00 00 90 10 02 40 f9 
  00000230  f0 03 00 f9 00 00 00 94  00 00 00 90 00 00 00 91 
  00000240  00 00 09 91 01 00 00 90  21 00 40 f9 10 00 00 90 
  00000250  10 02 40 f9 f0 03 00 f9  00 00 00 94 00 00 00 90 
  00000260  00 00 00 91 00 60 09 91  00 00 00 94 f0 53 40 f9 
  00000270  f0 77 00 f9 f0 77 40 f9  00 02 40 fd e0 7b 00 fd 
  00000280  f0 53 40 f9 f0 7f 00 f9  f0 7f 40 f9 11 01 80 d2 
  00000290  10 02 11 8b f0 83 00 f9  f0 83 40 f9 f0 87 00 f9 
  000002a0  f0 87 40 f9 00 02 40 fd  e0 8b 00 fd 00 00 00 90 
  000002b0  00 00 00 91 00 c0 09 91  e0 7b 40 fd e0 7b 40 fd 
  000002c0  e0 03 00 fd e1 8b 40 fd  e0 8b 40 fd e0 07 00 fd 
  000002d0  00 00 00 94 f0 5b 40 f9  f0 93 00 f9 f0 93 40 f9 
  000002e0  11 02 c0 39 f1 97 00 f9  f0 5b 40 f9 f0 9b 00 f9 
  000002f0  f0 9b 40 f9 31 00 80 d2  10 02 11 8b f0 9f 00 f9 
  00000300  f0 9f 40 f9 f0 a3 00 f9  f0 a3 40 f9 11 02 c0 39 
  00000310  f1 a7 00 f9 f0 5b 40 f9  f0 ab 00 f9 f0 ab 40 f9 
  00000320  51 00 80 d2 10 02 11 8b  f0 af 00 f9 f0 af 40 f9 
  00000330  f0 b3 00 f9 f0 b3 40 f9  11 02 c0 39 f1 b7 00 f9 
  00000340  00 00 00 90 00 00 00 91  00 20 0a 91 e1 a3 c4 39 
  00000350  f0 a3 c4 39 f0 03 00 f9  e2 23 c5 39 f0 23 c5 39 
  00000360  f0 07 00 f9 e3 a3 c5 39  f0 a3 c5 39 f0 0b 00 f9 
  00000370  00 00 00 94 00 00 00 90  00 00 00 91 00 a0 0a 91 
  00000380  00 00 00 94 bf 03 00 91  f0 03 00 91 10 c2 0d 91 
  00000390  1d 7a 40 a9 ff 03 0e 91  00 00 80 d2 c0 03 5f d6 
