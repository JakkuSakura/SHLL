...
fn main
  ...
  bb1 bb1
    ...
    store mem(AsmMemoryOperand { base: Some(Virtual { id: 12, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: None, address_space: None, pre_indexed: false, post_indexed: false }), Virtual { id: 14, bank: General, size_bits: 64 }
    ...
    eq Virtual { id: 17, bank: General, size_bits: 8 }, Virtual { id: 16, bank: General, size_bits: 64 }, 1
    condbr
  bb2 bb2
  ...
  bb3 bb3
    ...
    ret
fn __fp_comptime_const_WORD_LENGTHS_10120206226513811177
  bb0 bb0
    alloca Virtual { id: 59, bank: General, size_bits: 64 }, 1
    store mem(AsmMemoryOperand { base: Some(Virtual { id: 59, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: None, address_space: None, pre_indexed: false, post_indexed: false }), 5
    alloca Virtual { id: 61, bank: General, size_bits: 64 }, 1
    store mem(AsmMemoryOperand { base: Some(Virtual { id: 61, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: None, address_space: None, pre_indexed: false, post_indexed: false }), 4
    ...
    store mem(AsmMemoryOperand { base: Some(Virtual { id: 65, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: None, address_space: None, pre_indexed: false, post_indexed: false }), 5
    load Virtual { id: 67, bank: General, size_bits: 64 }, mem(AsmMemoryOperand { base: Some(Virtual { id: 59, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: Some(8), address_space: None, pre_indexed: false, post_indexed: false })
    load Virtual { id: 68, bank: General, size_bits: 64 }, mem(AsmMemoryOperand { base: Some(Virtual { id: 61, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: Some(8), address_space: None, pre_indexed: false, post_indexed: false })
    load Virtual { id: 69, bank: General, size_bits: 64 }, mem(AsmMemoryOperand { base: Some(Virtual { id: 63, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: Some(8), address_space: None, pre_indexed: false, post_indexed: false })
    load Virtual { id: 70, bank: General, size_bits: 64 }, mem(AsmMemoryOperand { base: Some(Virtual { id: 65, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: Some(8), address_space: None, pre_indexed: false, post_indexed: false })
    insertvalue Virtual { id: 71, bank: General, size_bits: 256 }, 0, Virtual { id: 67, bank: General, size_bits: 64 }, 0
    insertvalue Virtual { id: 72, bank: General, size_bits: 256 }, Virtual { id: 71, bank: General, size_bits: 64 }, Virtual { id: 68, bank: General, size_bits: 64 }, 1
    insertvalue Virtual { id: 73, bank: General, size_bits: 256 }, Virtual { id: 72, bank: General, size_bits: 64 }, Virtual { id: 69, bank: General, size_bits: 64 }, 2
    insertvalue Virtual { id: 74, bank: General, size_bits: 256 }, Virtual { id: 73, bank: General, size_bits: 64 }, Virtual { id: 70, bank: General, size_bits: 64 }, 3
    ret
fn __fp_comptime_const_TOTAL_WORD_LEN_154402109163011065
  bb0 bb0
    alloca Virtual { id: 75, bank: General, size_bits: 64 }, 1
    alloca Virtual { id: 76, bank: General, size_bits: 64 }, 1
    add Virtual { id: 77, bank: General, size_bits: 64 }, 5, 4
    ...
    load Virtual { id: 80, bank: General, size_bits: 64 }, mem(AsmMemoryOperand { base: Some(Virtual { id: 76, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: Some(8), address_space: None, pre_indexed: false, post_indexed: false })
    add Virtual { id: 81, bank: General, size_bits: 64 }, Virtual { id: 80, bank: General, size_bits: 64 }, 5
    ...
    load Virtual { id: 83, bank: General, size_bits: 64 }, mem(AsmMemoryOperand { base: Some(Virtual { id: 79, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: Some(8), address_space: None, pre_indexed: false, post_indexed: false })
    add Virtual { id: 84, bank: General, size_bits: 64 }, Virtual { id: 83, bank: General, size_bits: 64 }, 5
    store mem(AsmMemoryOperand { base: Some(Virtual { id: 75, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: None, address_space: None, pre_indexed: false, post_indexed: false }), Virtual { id: 84, bank: General, size_bits: 64 }
    load Virtual { id: 86, bank: General, size_bits: 64 }, mem(AsmMemoryOperand { base: Some(Virtual { id: 75, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: Some(8), address_space: None, pre_indexed: false, post_indexed: false })
    ret
fn __fp_comptime_const_IS_EMPTY_12768764456387974082
  bb0 bb0
    alloca Virtual { id: 87, bank: General, size_bits: 64 }, 1
    eq Virtual { id: 88, bank: General, size_bits: 8 }, 10, 0
    ...
    load Virtual { id: 90, bank: General, size_bits: 8 }, mem(AsmMemoryOperand { base: Some(Virtual { id: 87, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: Some(1), address_space: None, pre_indexed: false, post_indexed: false })
    ret
fn __fp_comptime_const_IS_LONG_8594841449804628874
  bb0 bb0
    alloca Virtual { id: 91, bank: General, size_bits: 64 }, 1
    gt Virtual { id: 92, bank: General, size_bits: 8 }, 10, 5
    store mem(AsmMemoryOperand { base: Some(Virtual { id: 91, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: None, address_space: None, pre_indexed: false, post_indexed: false }), Virtual { id: 92, bank: General, size_bits: 64 }
    ...
    ret
fn __fp_comptime_const_BUFFER_SIZE_1466670016178464282
  bb0 bb0
    alloca Virtual { id: 96, bank: General, size_bits: 64 }, 1
    alloca Virtual { id: 97, bank: General, size_bits: 64 }, 1
    gt Virtual { id: 98, bank: General, size_bits: 8 }, 10, 8
    store mem(AsmMemoryOperand { base: Some(Virtual { id: 97, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: None, address_space: None, pre_indexed: false, post_indexed: false }), Virtual { id: 98, bank: General, size_bits: 64 }
    load Virtual { id: 100, bank: General, size_bits: 8 }, mem(AsmMemoryOperand { base: Some(Virtual { id: 97, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: Some(1), address_space: None, pre_indexed: false, post_indexed: false })
    eq Virtual { id: 101, bank: General, size_bits: 8 }, Virtual { id: 100, bank: General, size_bits: 64 }, 1
    condbr
  bb1 bb1
    store mem(AsmMemoryOperand { base: Some(Virtual { id: 96, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: None, address_space: None, pre_indexed: false, post_indexed: false }), 256
    br
  bb2 bb2
    store mem(AsmMemoryOperand { base: Some(Virtual { id: 96, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: None, address_space: None, pre_indexed: false, post_indexed: false }), 256
    store mem(AsmMemoryOperand { base: Some(Virtual { id: 96, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: None, address_space: None, pre_indexed: false, post_indexed: false }), 128
    br
  bb3 bb3
    load Virtual { id: 105, bank: General, size_bits: 64 }, mem(AsmMemoryOperand { base: Some(Virtual { id: 96, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: Some(8), address_space: None, pre_indexed: false, post_indexed: false })
    ret


Symbols:
  main                             0x00000000
  __fp_comptime_const_WORD_LENGTHS_10120206226513811177 0x000004c4
  __fp_comptime_const_TOTAL_WORD_LEN_154402109163011065 0x00000678
  __fp_comptime_const_IS_EMPTY_12768764456387974082 0x00000728
  __fp_comptime_const_IS_LONG_8594841449804628874 0x0000077c
  __fp_comptime_const_BUFFER_SIZE_1466670016178464282 0x000007d0
...
.text (2184 bytes):
  ...
  00000020  00 00 00 90 00 00 00 91  00 80 01 91 00 00 00 94 
  00000030  00 00 00 90 00 00 00 91  00 20 02 91 00 00 00 94 
  00000040  00 00 00 90 00 00 00 91  00 20 03 91 00 00 00 94 
  00000050  00 00 00 90 00 00 00 91  00 e0 03 91 00 00 00 94 
  00000060  00 00 00 90 00 00 00 91  00 80 04 91 00 00 00 94 
  00000070  00 00 00 90 00 00 00 91  00 a0 04 91 01 00 00 90 
  00000080  21 00 00 91 10 00 00 90  10 02 00 91 f0 03 00 f9 
  00000090  42 01 80 d2 50 01 80 d2  f0 07 00 f9 00 00 00 94 
  000000a0  00 00 00 90 00 00 00 91  00 00 05 91 01 00 00 90 
  000000b0  21 00 00 91 10 00 00 90  10 02 00 91 f0 03 00 f9 
  000000c0  a2 00 80 d2 b0 00 80 d2  f0 07 00 f9 00 00 00 94 
  000000d0  00 00 00 90 00 00 00 91  00 60 05 91 21 00 80 d2 
  000000e0  30 00 80 d2 f0 03 00 f9  22 00 80 d2 30 00 80 d2 
  000000f0  f0 07 00 f9 23 00 80 d2  30 00 80 d2 f0 0b 00 f9 
  00000100  00 00 00 94 00 00 00 90  00 00 00 91 00 20 06 91 
  ...
  00000140  00 00 00 91 00 a0 06 91  00 00 00 94 f1 13 40 f9 
  ...
  000003d0  f1 b3 00 f9 00 00 00 90  00 00 00 91 00 c0 06 91 
  ...
  00000420  4f ff ff 17 00 00 00 90  00 00 00 91 00 20 07 91 
  00000430  61 02 80 d2 70 02 80 d2  f0 03 00 f9 00 00 00 94 
  00000440  00 00 00 90 00 00 00 91  00 80 07 91 01 00 80 d2 
  00000450  10 00 80 d2 f0 03 00 f9  22 00 80 d2 30 00 80 d2 
  00000460  f0 07 00 f9 00 00 00 94  00 00 00 90 00 00 00 91 
  00000470  00 e0 07 91 01 00 00 90  21 00 00 91 10 00 00 90 
  00000480  10 02 00 91 f0 03 00 f9  00 00 00 94 00 00 00 90 
  00000490  00 00 00 91 00 20 08 91  01 20 80 d2 10 20 80 d2 
  000004a0  f0 03 00 f9 00 00 00 94  bf 03 00 91 f0 03 00 91 
  000004b0  10 c2 0c 91 1d 7a 40 a9  ff 03 0d 91 00 00 80 d2 
  000004c0  c0 03 5f d6 ff 03 06 d1  fd 7b 17 a9 fd 03 00 91 
  000004d0  e0 63 00 f9 f0 03 00 91  10 22 05 91 f0 03 00 f9 
  000004e0  f1 03 40 f9 b0 00 80 d2  30 02 00 f9 f0 03 00 91 
  000004f0  10 42 05 91 f0 0b 00 f9  f1 0b 40 f9 90 00 80 d2 
  00000500  30 02 00 f9 f0 03 00 91  10 62 05 91 f0 13 00 f9 
  00000510  f1 13 40 f9 b0 00 80 d2  30 02 00 f9 f0 03 00 91 
  00000520  10 82 05 91 f0 1b 00 f9  f1 1b 40 f9 b0 00 80 d2 
  00000530  30 02 00 f9 f0 03 40 f9  11 02 40 f9 f1 23 00 f9 
  00000540  f0 0b 40 f9 11 02 40 f9  f1 27 00 f9 f0 13 40 f9 
  00000550  11 02 40 f9 f1 2b 00 f9  f0 1b 40 f9 11 02 40 f9 
  00000560  f1 2f 00 f9 10 00 80 d2  f0 67 00 f9 f0 6b 00 f9 
  00000570  f0 6f 00 f9 f0 73 00 f9  f0 23 40 f9 f0 67 00 f9 
  00000580  f0 03 00 91 10 22 03 91  f0 33 00 f9 f0 67 40 f9 
  00000590  f0 77 00 f9 f0 6b 40 f9  f0 7b 00 f9 f0 6f 40 f9 
  000005a0  f0 7f 00 f9 f0 73 40 f9  f0 83 00 f9 f0 27 40 f9 
  000005b0  f0 7b 00 f9 f0 03 00 91  10 a2 03 91 f0 37 00 f9 
  000005c0  f0 77 40 f9 f0 87 00 f9  f0 7b 40 f9 f0 8b 00 f9 
  000005d0  f0 7f 40 f9 f0 8f 00 f9  f0 83 40 f9 f0 93 00 f9 
  000005e0  f0 2b 40 f9 f0 8f 00 f9  f0 03 00 91 10 22 04 91 
  000005f0  f0 3b 00 f9 f0 87 40 f9  f0 97 00 f9 f0 8b 40 f9 
  00000600  f0 9b 00 f9 f0 8f 40 f9  f0 9f 00 f9 f0 93 40 f9 
  00000610  f0 a3 00 f9 f0 2f 40 f9  f0 a3 00 f9 f0 03 00 91 
  00000620  10 a2 04 91 f0 3f 00 f9  f1 63 40 f9 f0 97 40 f9 
  00000630  e9 03 11 aa 30 01 00 f9  f0 9b 40 f9 e9 03 11 aa 
  00000640  29 21 00 91 30 01 00 f9  f0 9f 40 f9 e9 03 11 aa 
  00000650  29 41 00 91 30 01 00 f9  f0 a3 40 f9 e9 03 11 aa 
  00000660  29 61 00 91 30 01 00 f9  bf 03 00 91 fd 7b 57 a9 
  00000670  ff 03 06 91 c0 03 5f d6  ff 83 02 d1 fd 7b 09 a9 
  00000680  fd 03 00 91 f0 03 00 91  10 e2 01 91 f0 03 00 f9 
  00000690  f0 03 00 91 10 02 02 91  f0 07 00 f9 b0 00 80 d2 
  000006a0  10 12 00 91 f0 0b 00 f9  f1 07 40 f9 f0 0b 40 f9 
  000006b0  30 02 00 f9 f0 03 00 91  10 22 02 91 f0 13 00 f9 
  000006c0  f0 07 40 f9 11 02 40 f9  f1 17 00 f9 f0 17 40 f9 
  000006d0  10 16 00 91 f0 1b 00 f9  f1 13 40 f9 f0 1b 40 f9 
  000006e0  30 02 00 f9 f0 13 40 f9  11 02 40 f9 f1 23 00 f9 
  000006f0  f0 23 40 f9 10 16 00 91  f0 27 00 f9 f1 03 40 f9 
  00000700  f0 27 40 f9 30 02 00 f9  f0 03 40 f9 11 02 40 f9 
  00000710  f1 2f 00 f9 e0 2f 40 f9  bf 03 00 91 fd 7b 49 a9 
  00000720  ff 83 02 91 c0 03 5f d6  ff 03 01 d1 fd 7b 03 a9 
  00000730  fd 03 00 91 f0 03 00 91  10 a2 00 91 f0 03 00 f9 
  00000740  50 01 80 d2 1f 02 00 f1  f0 17 9f 9a f0 07 00 f9 
  00000750  f1 03 40 f9 f0 23 40 39  30 02 00 39 f0 03 40 f9 
  00000760  11 02 40 39 f1 0f 00 f9  e0 63 40 39 bf 03 00 91 
  00000770  fd 7b 43 a9 ff 03 01 91  c0 03 5f d6 ff 03 01 d1 
  00000780  fd 7b 03 a9 fd 03 00 91  f0 03 00 91 10 a2 00 91 
  00000790  f0 03 00 f9 50 01 80 d2  1f 16 00 f1 f0 d7 9f 9a 
  000007a0  f0 07 00 f9 f1 03 40 f9  f0 23 40 39 30 02 00 39 
  000007b0  f0 03 40 f9 11 02 40 39  f1 0f 00 f9 e0 63 40 39 
  000007c0  bf 03 00 91 fd 7b 43 a9  ff 03 01 91 c0 03 5f d6 
  000007d0  ff 03 02 d1 fd 7b 07 a9  fd 03 00 91 f0 03 00 91 
  000007e0  10 82 01 91 f0 03 00 f9  f0 03 00 91 10 a2 01 91 
  000007f0  f0 07 00 f9 50 01 80 d2  1f 22 00 f1 f0 d7 9f 9a 
  00000800  f0 0b 00 f9 f1 07 40 f9  f0 43 40 39 30 02 00 39 
  00000810  f0 07 40 f9 11 02 40 39  f1 13 00 f9 f0 83 40 39 
  00000820  1f 06 00 f1 f0 17 9f 9a  f0 17 00 f9 f0 17 40 f9 
  00000830  1f 02 00 f1 41 00 00 54  05 00 00 14 f1 03 40 f9 
  00000840  10 20 80 d2 30 02 00 f9  08 00 00 14 f1 03 40 f9 
  00000850  10 20 80 d2 30 02 00 f9  f1 03 40 f9 10 10 80 d2 
  00000860  30 02 00 f9 01 00 00 14  f0 03 40 f9 11 02 40 f9 
  00000870  f1 27 00 f9 e0 27 40 f9  bf 03 00 91 fd 7b 47 a9 
  00000880  ff 03 02 91 c0 03 5f d6 
...
.rodata (538 bytes):
  ...
  00000060  f0 9f 93 98 20 54 75 74  6f 72 69 61 6c 3a 20 30 
  00000070  32 5f 73 74 72 69 6e 67  5f 70 72 6f 63 65 73 73 
  00000080  69 6e 67 2e 66 70 0a 00  f0 9f a7 ad 20 46 6f 63 
  00000090  75 73 3a 20 43 6f 6d 70  69 6c 65 2d 74 69 6d 65 
  000000a0  20 73 74 72 69 6e 67 20  6f 70 65 72 61 74 69 6f 
  000000b0  6e 73 20 61 6e 64 20 69  6e 74 72 69 6e 73 69 63 
  000000c0  73 0a 00 00 00 00 00 00  f0 9f a7 aa 20 57 68 61 
  ...
  00000120  0a 00 00 00 00 00 00 00  6e 61 6d 65 3d 27 25 73 
  00000130  27 20 6c 65 6e 3d 25 6c  6c 75 0a 00 00 00 00 00 
  00000140  76 65 72 73 69 6f 6e 3d  27 25 73 27 20 6c 65 6e 
  00000150  3d 25 6c 6c 75 0a 00 00  70 72 65 66 69 78 5f 6f 
  00000160  6b 3d 25 64 2c 20 73 75  66 66 69 78 5f 6f 6b 3d 
  00000170  25 64 2c 20 63 6f 6e 74  61 69 6e 73 5f 70 68 61 
  00000180  73 65 3d 25 64 0a 00 00  73 6c 69 63 65 73 3a 20 
  00000190  73 68 6f 72 74 3d 27 25  73 27 20 74 61 69 6c 3d 
  000001a0  27 25 73 27 0a 00 00 00  77 6f 72 64 73 3a 0a 00 
  000001b0  20 20 25 73 20 2d 3e 20  6c 65 6e 3d 25 6c 6c 75 
  000001c0  0a 00 00 00 00 00 00 00  74 6f 74 61 6c 20 77 6f 
  000001d0  72 64 20 6c 65 6e 67 74  68 3d 25 6c 6c 75 0a 00 
  000001e0  65 6d 70 74 79 3d 25 64  2c 20 6c 6f 6e 67 3d 25 
  000001f0  64 0a 00 00 00 00 00 00  62 61 6e 6e 65 72 3d 27 
  00000200  25 73 27 0a 00 00 00 00  62 75 66 66 65 72 5f 73 
  00000210  69 7a 65 3d 25 6c 6c 75  0a 00 
