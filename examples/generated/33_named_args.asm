fp-native dump: format=MachO arch=Aarch64 entry=0x6224
...
fn Vec__new__mono_7add67d613152ef9
  bb0 bb0
    ret
fn examples__33_named_args__summarize
  bb0 bb0
    ...
    bitcast Virtual { id: 3, bank: General, size_bits: 64 }, Virtual { id: 1, bank: General, size_bits: 64 }
    load Virtual { id: 4, bank: General, size_bits: 64 }, mem(AsmMemoryOperand { base: Some(Virtual { id: 3, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: Some(8), address_space: None, pre_indexed: false, post_indexed: false })
    intrinsic.call symbol(intrinsic.format), Virtual { id: 4, bank: General, size_bits: 64 }, symbol(local.2), symbol(local.3)
    store mem(AsmMemoryOperand { base: Some(Virtual { id: 0, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: None, address_space: None, pre_indexed: false, post_indexed: false }), Virtual { id: 5, bank: General, size_bits: 64 }
    load Virtual { id: 7, bank: General, size_bits: 64 }, mem(AsmMemoryOperand { base: Some(Virtual { id: 0, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: Some(16), address_space: None, pre_indexed: false, post_indexed: false })
    ret
fn examples__33_named_args__add
  bb0 bb0
...
fn main
  bb0 bb0
    ...
    intrinsic.call symbol(intrinsic.println)
    intrinsic.call symbol(intrinsic.println)
    call symbol(examples__33_named_args__summarize)(struct(len=2), 3, true) cc=C tail=false
    alloca Virtual { id: 17, bank: General, size_bits: 64 }, 1
  ...
  bb1 bb1
    ...
    call symbol(examples__33_named_args__summarize)(struct(len=2), 7, false) cc=C tail=false
    alloca Virtual { id: 23, bank: General, size_bits: 64 }, 1
  ...
  bb2 bb2
    ...
    call symbol(examples__33_named_args__add)(5, 2) cc=C tail=false
    br
  bb3 bb3
...
Symbols:
  ...
  examples__33_named_args__summarize 0x0000602c
  examples__33_named_args__add     0x000061c8
  main                             0x00006224

Text relocations:
  offset=0x000060b4 kind=Aarch64AdrpAdd symbol=fp_rodata_base addend=0
  offset=0x000060e4 kind=CallRel32 symbol=snprintf addend=0
  offset=0x000060fc kind=CallRel32 symbol=malloc addend=0
  offset=0x00006110 kind=Aarch64AdrpAdd symbol=fp_rodata_base addend=0
  offset=0x00006140 kind=CallRel32 symbol=snprintf addend=0
  offset=0x00006230 kind=Aarch64AdrpAdd symbol=fp_rodata_base addend=0
  offset=0x0000623c kind=CallRel32 symbol=printf addend=0
  offset=0x00006240 kind=Aarch64AdrpAdd symbol=fp_rodata_base addend=0
  offset=0x0000624c kind=CallRel32 symbol=printf addend=0
  offset=0x00006250 kind=Aarch64AdrpAdd symbol=fp_rodata_base addend=0
  offset=0x0000625c kind=CallRel32 symbol=printf addend=0
  offset=0x00006260 kind=Aarch64AdrpAdd symbol=fp_rodata_base addend=0
  offset=0x0000626c kind=CallRel32 symbol=printf addend=0
  offset=0x00006280 kind=Aarch64AdrpAdd symbol=__const_data_0 addend=0
  offset=0x0000630c kind=Aarch64AdrpAdd symbol=fp_rodata_base addend=0
  offset=0x00006324 kind=CallRel32 symbol=printf addend=0
  offset=0x00006338 kind=Aarch64AdrpAdd symbol=__const_data_1 addend=0
  offset=0x000063c4 kind=Aarch64AdrpAdd symbol=fp_rodata_base addend=0
  offset=0x000063dc kind=CallRel32 symbol=printf addend=0
  offset=0x000063f4 kind=Aarch64AdrpAdd symbol=fp_rodata_base addend=0
  offset=0x0000640c kind=CallRel32 symbol=printf addend=0
...
.text (25636 bytes):
  ...
  00006020  00 00 20 d4 c0 03 5f d6  c0 03 5f d6 ff c3 03 d1 
  00006030  fd 7b 0e a9 fd 03 00 91  e0 4b 00 f9 e9 03 01 aa 
  00006040  30 01 40 f9 f0 3b 00 f9  e9 03 01 aa 29 21 00 91 
  00006050  30 01 40 f9 f0 3f 00 f9  e2 43 00 f9 e3 23 02 39 
  00006060  f0 03 00 91 10 e2 02 91  f0 13 00 f9 f0 03 00 91 
  00006070  10 22 03 91 f0 17 00 f9  f1 17 40 f9 f0 3b 40 f9 
  00006080  e9 03 11 aa 30 01 00 f9  f0 3f 40 f9 e9 03 11 aa 
  00006090  29 21 00 91 30 01 00 f9  f0 17 40 f9 f0 1f 00 f9 
  000060a0  f0 1f 40 f9 11 02 40 f9  f1 23 00 f9 00 00 80 d2 
  000060b0  01 00 80 d2 02 00 00 90  42 00 00 91 42 40 00 91 
  000060c0  e3 23 40 f9 f0 23 40 f9  f0 03 00 f9 e4 43 40 f9 
  000060d0  f0 43 40 f9 f0 07 00 f9  e5 23 42 39 f0 23 42 39 
  000060e0  f0 0b 00 f9 00 00 00 94  f0 03 00 aa f0 53 00 f9 
  000060f0  10 06 00 91 f0 27 00 f9  e0 03 10 aa 00 00 00 94 
  00006100  e9 03 00 aa e0 03 09 aa  e1 27 40 f9 e9 27 00 f9 
  00006110  02 00 00 90 42 00 00 91  42 40 00 91 e3 23 40 f9 
  00006120  f0 23 40 f9 f0 03 00 f9  e4 43 40 f9 f0 43 40 f9 
  00006130  f0 07 00 f9 e5 23 42 39  f0 23 42 39 f0 0b 00 f9 
  00006140  00 00 00 94 e9 27 40 f9  e9 4f 00 f9 f1 13 40 f9 
  00006150  f0 4f 40 f9 e9 03 11 aa  30 01 00 f9 f0 53 40 f9 
  00006160  e9 03 11 aa 29 21 00 91  30 01 00 f9 f1 13 40 f9 
  00006170  e9 03 11 aa 30 01 40 f9  f0 57 00 f9 e9 03 11 aa 
  00006180  29 21 00 91 30 01 40 f9  f0 5b 00 f9 f0 03 00 91 
  00006190  10 a2 02 91 f0 2f 00 f9  f1 4b 40 f9 f0 57 40 f9 
  000061a0  e9 03 11 aa 30 01 00 f9  f0 5b 40 f9 e9 03 11 aa 
  000061b0  29 21 00 91 30 01 00 f9  bf 03 00 91 fd 7b 4e a9 
  000061c0  ff c3 03 91 c0 03 5f d6  ff 43 01 d1 fd 7b 04 a9 
  000061d0  fd 03 00 91 e0 17 00 f9  e1 1b 00 f9 f0 03 00 91 
  000061e0  10 e2 00 91 f0 03 00 f9  f0 17 40 f9 f1 1b 40 f9 
  000061f0  10 02 11 8b f0 07 00 f9  f1 03 40 f9 f0 07 40 f9 
  00006200  30 02 00 f9 f0 03 40 f9  11 02 40 f9 f1 0f 00 f9 
  00006210  e0 0f 40 f9 bf 03 00 91  fd 7b 44 a9 ff 43 01 91 
  00006220  c0 03 5f d6 ff c3 05 d1  fd 7b 16 a9 fd 03 00 91 
  00006230  00 00 00 90 00 00 00 91  00 c0 00 91 00 00 00 94 
  00006240  00 00 00 90 00 00 00 91  00 40 01 91 00 00 00 94 
  00006250  00 00 00 90 00 00 00 91  00 00 02 91 00 00 00 94 
  00006260  00 00 00 90 00 00 00 91  00 e0 02 91 00 00 00 94 
  00006270  e0 03 00 91 00 60 04 91  f1 03 00 91 31 22 04 91 
  00006280  10 00 00 90 10 02 00 91  e9 03 11 aa 30 01 00 f9 
  00006290  b0 00 80 d2 10 00 a0 f2  10 00 c0 f2 10 00 e0 f2 
  000062a0  e9 03 11 aa 29 21 00 91  30 01 00 f9 e1 03 11 aa 
  000062b0  62 00 80 d2 23 00 80 d2  5d ff ff 97 f0 03 00 91 
  000062c0  10 62 04 91 f0 1b 00 f9  f0 03 00 91 10 e2 04 91 
  000062d0  f0 1f 00 f9 f1 1f 40 f9  f0 8f 40 f9 e9 03 11 aa 
  000062e0  30 01 00 f9 f0 93 40 f9  e9 03 11 aa 29 21 00 91 
  000062f0  30 01 00 f9 01 00 00 14  f0 1f 40 f9 f0 27 00 f9 
  00006300  f0 27 40 f9 11 02 40 f9  f1 2b 00 f9 00 00 00 90 
  00006310  00 00 00 91 00 00 03 91  e1 2b 40 f9 f0 2b 40 f9 
  00006320  f0 03 00 f9 00 00 00 94  e0 03 00 91 00 a0 04 91 
  00006330  f1 03 00 91 31 22 04 91  10 00 00 90 10 02 00 91 
  00006340  e9 03 11 aa 30 01 00 f9  90 00 80 d2 10 00 a0 f2 
  00006350  10 00 c0 f2 10 00 e0 f2  e9 03 11 aa 29 21 00 91 
  00006360  30 01 00 f9 e1 03 11 aa  e2 00 80 d2 03 00 80 d2 
  00006370  2f ff ff 97 f0 03 00 91  10 a2 04 91 f0 33 00 f9 
  00006380  f0 03 00 91 10 22 05 91  f0 37 00 f9 f1 37 40 f9 
  00006390  f0 97 40 f9 e9 03 11 aa  30 01 00 f9 f0 9b 40 f9 
  000063a0  e9 03 11 aa 29 21 00 91  30 01 00 f9 01 00 00 14 
  000063b0  f0 37 40 f9 f0 3f 00 f9  f0 3f 40 f9 11 02 40 f9 
  000063c0  f1 43 00 f9 00 00 00 90  00 00 00 91 00 40 03 91 
  000063d0  e1 43 40 f9 f0 43 40 f9  f0 03 00 f9 00 00 00 94 
  000063e0  a0 00 80 d2 41 00 80 d2  78 ff ff 97 e0 4b 00 f9 
  000063f0  01 00 00 14 00 00 00 90  00 00 00 91 00 80 03 91 
  00006400  e1 4b 40 f9 f0 4b 40 f9  f0 03 00 f9 00 00 00 94 
  00006410  bf 03 00 91 fd 7b 56 a9  ff c3 05 91 00 00 80 d2 
  00006420  c0 03 5f d6 

.rodata (235 bytes):
  00000000  00 00 00 61 6c 70 68 61  00 62 65 74 61 00 00 00 
