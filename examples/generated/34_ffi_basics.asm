...
Text relocations:
  ...
  offset=0x0000005c kind=CallRel32 symbol=strlen addend=0
...
.text (176 bytes):
  00000000  ff 83 02 d1 fd 7b 09 a9  fd 03 00 91 f0 03 00 91 
  00000010  10 02 02 91 f0 0b 00 f9  f1 0b 40 f9 10 00 00 90 
  00000020  10 02 00 91 30 02 00 f9  f0 03 00 91 10 22 02 91 
  00000030  f0 13 00 f9 f0 0b 40 f9  11 02 40 f9 f1 17 00 f9 
  00000040  f1 13 40 f9 f0 17 40 f9  30 02 00 f9 f0 13 40 f9 
  00000050  11 02 40 f9 f1 1f 00 f9  e0 1f 40 f9 00 00 00 94 
  00000060  e0 23 00 f9 01 00 00 14  f0 0b 40 f9 11 02 40 f9 
  00000070  f1 27 00 f9 00 00 00 90  00 00 00 91 00 40 00 91 
  00000080  e1 27 40 f9 f0 27 40 f9  f0 03 00 f9 e2 23 40 f9 
  00000090  f0 23 40 f9 f0 07 00 f9  00 00 00 94 bf 03 00 91 
  000000a0  fd 7b 49 a9 ff 83 02 91  00 00 80 d2 c0 03 5f d6 

.rodata (37 bytes):
  00000000  68 65 6c 6c 6f 20 66 72  6f 6d 20 66 66 69 00 00 
  00000010  73 74 72 6c 65 6e 28 27  25 70 27 29 20 3d 20 25 
