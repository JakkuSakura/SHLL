...
fn main
  bb0 bb0
    ...
    store mem(AsmMemoryOperand { base: Some(Virtual { id: 1, bank: General, size_bits: 64 }), index: None, scale: 1, displacement: 0, segment: None, size_bytes: None, address_space: None, pre_indexed: false, post_indexed: false }), symbol(__const_data_0)
    ...
    call symbol(strlen)(v6) cc=C tail=false
    br
  bb1 bb1
...
.text (156 bytes):
  ...
  00000010  f0 03 00 91 10 e2 01 91  f0 0b 00 f9 f1 0b 40 f9 
  00000020  10 00 00 90 10 02 00 91  30 02 00 f9 f0 03 00 91 
  00000030  10 e2 02 91 f0 13 00 f9  f0 0b 40 f9 11 02 40 f9 
  ...
  00000080  f0 03 00 f9 00 00 00 94  bf 03 00 91 fd 7b 50 a9 
  00000090  ff 43 04 91 00 00 80 d2  c0 03 5f d6 
