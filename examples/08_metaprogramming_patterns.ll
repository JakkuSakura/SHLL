...
@.str.08_metaprogramming_patterns.0 = constant [18 x i8] [i8 37, i8 115, i8 32, i8 104, i8 97, i8 115, i8 32, i8 37, i8 100, i8 32, i8 102, i8 105, i8 101, i8 108, i8 100, i8 115, i8 10, i8 0], align 1
@.str.08_metaprogramming_patterns.1 = constant [22 x i8] [i8 116, i8 97, i8 103, i8 32, i8 100, i8 105, i8 115, i8 99, i8 114, i8 105, i8 109, i8 105, i8 110, i8 97, i8 110, i8 116, i8 58, i8 32, i8 37, i8 100, i8 10, i8 0], align 1
...
bb0:
  ...
  store i64 3, ptr %alloca_15
  %load_17 = load i64, ptr %alloca_15
  ret i64 %load_17
}
...
bb3:
  ...
  %call_11 = call i32 (ptr, ...) @printf(ptr @.str.08_metaprogramming_patterns.1, i32 %zext_10)
  br label %bb4
bb4:
  ret i32 0
}
...
bb0:
  ...
  store ptr @.str.08_metaprogramming_patterns.2, ptr %alloca_12
  %load_14 = load ptr, ptr %alloca_12
  ret ptr %load_14
}
