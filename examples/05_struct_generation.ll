...
@.str.0 = constant [12 x i8] [i8 120, i8 61, i8 37, i8 100, i8 44, i8 32, i8 121, i8 61, i8 37, i8 100, i8 10, i8 0], align 1
@.str.1 = constant [16 x i8] [i8 97, i8 114, i8 114, i8 97, i8 121, i8 32, i8 115, i8 105, i8 122, i8 101, i8 58, i8 32, i8 37, i8 100, i8 10, i8 0], align 1
...
bb0:
  ...
  %call_10 = call i32 (ptr, ...) @printf(ptr @.str.0, i64 %load_5, i64 %load_9)
  br label %bb1
bb1:
  %call_11 = call i32 (ptr, ...) @printf(ptr @.str.1, i64 256)
  br label %bb2
bb2:
  ret i32 0
}
