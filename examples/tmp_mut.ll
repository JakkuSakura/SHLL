...
bb0:
  ...
  call i32 @printf(ptr getelementptr inbounds ([15 x i8], ptr @.str.0, i32 0, i32 0), i64 %load_2)
  br label %bb1
bb1:
  ...
  call i32 @printf(ptr getelementptr inbounds ([23 x i8], ptr @.str.1, i32 0, i32 0), i64 %load_7)
  br label %bb2
bb2:
  ...
  call i32 @printf(ptr getelementptr inbounds ([25 x i8], ptr @.str.2, i32 0, i32 0), i64 %load_12)
  br label %bb3
bb3:
  ...
  call i32 @printf(ptr getelementptr inbounds ([13 x i8], ptr @.str.3, i32 0, i32 0), i64 %load_17)
  br label %bb4
bb4:
  ret i32 0
}
