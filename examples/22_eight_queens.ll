...
bb0:
  ...
  store ptr %2, ptr %alloca_count_5, align 8
...
bb3:                                              ; preds = %bb10, %bb2
  ...
  store i64 0, ptr %alloca_count_4, align 8
  br label %bb11

bb7:                                              ; preds = %bb8, %bb4
  %load_25 = load i64, ptr %alloca_count_7, align 8
...
bb6:                                              ; preds = %bb9, %bb5
  ...
  %load_30 = load i64, ptr %alloca_count_2, align 8
  ret i64 %load_30

bb11:                                             ; preds = %bb16, %bb3
  %load_32 = load i64, ptr %alloca_count_4, align 8
...
bb8:                                              ; preds = %bb7
  %load_37 = load i64, ptr %alloca_count_7, align 8
  store i64 %load_37, ptr %alloca_count_36, align 8
  %load_40 = load i64, ptr %alloca_count_7, align 8
  ...
  %load_55 = load i64, ptr %alloca_count_7, align 8
  %iop_56 = add i64 %load_55, 1
  store i64 %iop_56, ptr %alloca_count_7, align 8
  br label %bb7
...
bb12:                                             ; preds = %bb11
  %load_60 = load i64, ptr %alloca_count_4, align 8
  ...
  %load_67 = load i64, ptr %alloca_count_4, align 8
  ...
  %load_78 = load i64, ptr %alloca_count_4, align 8
  ...
  %load_94 = load ptr, ptr %alloca_count_5, align 8
...
bb13:                                             ; preds = %bb11
  %load_127 = load i64, ptr %alloca_count_3, align 8
  store i64 %load_127, ptr %alloca_count_2, align 8
  %load_129 = load i64, ptr %alloca_count_2, align 8
  ret i64 %load_129

bb14:                                             ; preds = %bb12
  %load_131 = load i64, ptr %alloca_count_4, align 8
  ...
  %load_143 = load ptr, ptr %alloca_count_5, align 8
  ...
  %load_168 = load i64, ptr %alloca_count_4, align 8
  ...
  %load_175 = load ptr, ptr %alloca_count_5, align 8
...
bb17:                                             ; preds = %bb14
  %load_179 = load i64, ptr %alloca_count_3, align 8
  %iop_180 = add i64 %load_179, %call_178
  store i64 %iop_180, ptr %alloca_count_3, align 8
  %load_183 = load i64, ptr %alloca_count_4, align 8
  ...
  %load_195 = load ptr, ptr %alloca_count_5, align 8
...
bb16:                                             ; preds = %bb17, %bb15
  %load_222 = load i64, ptr %alloca_count_4, align 8
  %iop_223 = add i64 %load_222, 1
  store i64 %iop_223, ptr %alloca_count_4, align 8
  br label %bb11
