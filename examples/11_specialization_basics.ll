...
@.str.11_specialization_basics.0 = private unnamed_addr constant [44 x i8] c"\F0\9F\93\98 Tutorial: 11_specialization_basics.fp\0A\00", align 1
@.str.11_specialization_basics.1 = private unnamed_addr constant [66 x i8] c"\F0\9F\A7\AD Focus: Function specialization via generic monomorphization\0A\00", align 1
@.str.11_specialization_basics.2 = private unnamed_addr constant [46 x i8] c"\F0\9F\A7\AA What to look for: labeled outputs below\0A\00", align 1
@.str.11_specialization_basics.3 = private unnamed_addr constant [39 x i8] c"\E2\9C\85 Expectation: outputs match labels\0A\00", align 1
@.str.11_specialization_basics.4 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@.str.11_specialization_basics.5 = private unnamed_addr constant [21 x i8] c"sum_pair i64 = %lld\0A\00", align 1
@.str.11_specialization_basics.6 = private unnamed_addr constant [19 x i8] c"sum_pair f64 = %f\0A\00", align 1
@.str.11_specialization_basics.7 = private unnamed_addr constant [26 x i8] c"specialized result: %lld\0A\00", align 1
@.str.11_specialization_basics.8 = private unnamed_addr constant [24 x i8] c"specialized result: %f\0A\00", align 1
@.str.11_specialization_basics.9 = private unnamed_addr constant [24 x i8] c"max(%lld, %lld) = %lld\0A\00", align 1
@.str.11_specialization_basics.10 = private unnamed_addr constant [18 x i8] c"max(%f, %f) = %f\0A\00", align 1
...
bb5:                                              ; preds = %bb4
  %call_5 = call i64 @pipeline__mono_a7af9f593fdc4675_3(i64 10, i64 20)
  br label %bb6

bb6:                                              ; preds = %bb5
  %call_6 = call double @pipeline__mono_d7ad91e83a08a980_3(double 1.500000e+00, double 2.500000e+00)
  br label %bb7
...
bb7:                                              ; preds = %bb6
  ...
  %call_12 = call i64 @sum_pair__mono_a7af9f593fdc4675_4({ i64, i64 } %load_11)
  br label %bb8
...
bb8:                                              ; preds = %bb7
  ...
  %call_15 = call double @sum_pair__mono_d7ad91e83a08a980_4({ double, double } %load_14)
  br label %bb9

bb9:                                              ; preds = %bb8
  %call_16 = call i32 (ptr, ...) @printf(ptr @.str.11_specialization_basics.6, double %call_15)
  %call_17 = call i64 @max__mono_a7af9f593fdc4675_5(i64 10, i64 3)
  br label %bb10

bb10:                                             ; preds = %bb9
  %call_18 = call double @max__mono_d7ad91e83a08a980_5(double 2.500000e+00, double 9.000000e+00)
  br label %bb11
...
bb0:
  ...
  %call_28 = call i64 @add__mono_a7af9f593fdc4675_1(i64 %0, i64 %1)
  br label %bb1

bb1:                                              ; preds = %bb0
  %call_29 = call i64 @double__mono_a7af9f593fdc4675_2(i64 %call_28)
  br label %bb2
...
bb0:
  ...
  %call_42 = call double @add__mono_d7ad91e83a08a980_1(double %0, double %1)
  br label %bb1

bb1:                                              ; preds = %bb0
  %call_43 = call double @double__mono_d7ad91e83a08a980_2(double %call_42)
  br label %bb2
...
bb2:                                              ; preds = %bb0
  store i64 %1, ptr %alloca_count_76, align 8
  br label %bb3

bb3:                                              ; preds = %bb2, %bb1
  %load_84 = load i64, ptr %alloca_count_76, align 8
  ...
  store i64 %load_88, ptr %alloca_count_75, align 8
  %load_90 = load i64, ptr %alloca_count_75, align 8
  ret i64 %load_90
}
