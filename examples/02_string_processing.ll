...
@.str.1 = constant [18 x i8] [i8 110, i8 97, i8 109, i8 101, i8 61, i8 39, i8 37, i8 115, i8 39, i8 32, i8 108, i8 101, i8 110, i8 61, i8 37, i8 100, i8 10, i8 0], align 1
@.str.2 = constant [6 x i8] c"0.1.0\00", align 1
@.str.3 = constant [21 x i8] [i8 118, i8 101, i8 114, i8 115, i8 105, i8 111, i8 110, i8 61, i8 39, i8 37, i8 115, i8 39, i8 32, i8 108, i8 101, i8 110, i8 61, i8 37, i8 100, i8 10, i8 0], align 1
...
@.str.7 = constant [16 x i8] [i8 98, i8 117, i8 102, i8 102, i8 101, i8 114, i8 95, i8 115, i8 105, i8 122, i8 101, i8 61, i8 37, i8 100, i8 10, i8 0], align 1
declare i32 @printf(ptr, ...)
define i32 @main() {
bb0:
  %alloca_0 = alloca ptr, align 8
  store ptr @.str.0, ptr %alloca_0
  %alloca_2 = alloca i64, align 8
  store i64 10, ptr %alloca_2
  %load_4 = load ptr, ptr %alloca_0
  %load_5 = load i64, ptr %alloca_2
  %call_6 = call i32 (ptr, ...) @printf(ptr @.str.1, ptr %load_4, i64 %load_5)
  br label %bb1
bb1:
  %alloca_7 = alloca ptr, align 8
  store ptr @.str.2, ptr %alloca_7
  %alloca_9 = alloca i64, align 8
  store i64 5, ptr %alloca_9
  %load_11 = load ptr, ptr %alloca_7
  %load_12 = load i64, ptr %alloca_9
  %call_13 = call i32 (ptr, ...) @printf(ptr @.str.3, ptr %load_11, i64 %load_12)
  br label %bb2
bb2:
  ...
  %call_22 = call i32 (ptr, ...) @printf(ptr @.str.4, i32 %zext_19, i32 %zext_21)
  br label %bb3
bb3:
  %alloca_23 = alloca ptr, align 8
  store ptr @.str.5, ptr %alloca_23
  %load_25 = load ptr, ptr %alloca_23
  %call_26 = call i32 (ptr, ...) @printf(ptr @.str.6, ptr %load_25)
  br label %bb4
bb4:
  %alloca_27 = alloca i64, align 8
  store i64 256, ptr %alloca_27
  %load_29 = load i64, ptr %alloca_27
  %call_30 = call i32 (ptr, ...) @printf(ptr @.str.7, i64 %load_29)
  br label %bb5
bb5:
  ret i32 0
}
