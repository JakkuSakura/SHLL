...
bb2:
  ...
  %call_8 = call i32 (ptr, i64) @printf(ptr @.str.2, i64 %load_7)
  br label %bb3
bb3:
  %alloca_9 = alloca i64, align 8
  store i64 16, ptr %alloca_9
  %load_11 = load i64, ptr %alloca_9
  %call_12 = call i32 (ptr, i64) @printf(ptr @.str.3, i64 %load_11)
  br label %bb4
bb4:
...
bb5:
  ...
  %call_17 = call i32 (ptr, i64) @printf(ptr @.str.5, i64 %load_16)
  br label %bb6
bb6:
  ret i32 0
}
