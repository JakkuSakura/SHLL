...
@.str.06_struct_methods.1 = constant [19 x i8] [i8 112, i8 49, i8 32, i8 61, i8 32, i8 40, i8 37, i8 108, i8 108, i8 100, i8 44, i8 32, i8 37, i8 108, i8 108, i8 100, i8 41, i8 10, i8 0], align 1
@.str.06_struct_methods.2 = constant [19 x i8] [i8 112, i8 50, i8 32, i8 61, i8 32, i8 40, i8 37, i8 108, i8 108, i8 100, i8 44, i8 32, i8 37, i8 108, i8 108, i8 100, i8 41, i8 10, i8 0], align 1
@.str.06_struct_methods.3 = constant [35 x i8] [i8 112, i8 49, i8 32, i8 97, i8 102, i8 116, i8 101, i8 114, i8 32, i8 116, i8 114, i8 97, i8 110, i8 115, i8 108, i8 97, i8 116, i8 101, i8 32, i8 61, i8 32, i8 40, i8 37, i8 108, i8 108, i8 100, i8 44, i8 32, i8 37, i8 108, i8 108, i8 100, i8 41, i8 10, i8 0], align 1
@.str.06_struct_methods.4 = constant [27 x i8] [i8 68, i8 105, i8 115, i8 116, i8 97, i8 110, i8 99, i8 101, i8 194, i8 178, i8 40, i8 112, i8 49, i8 44, i8 32, i8 112, i8 50, i8 41, i8 32, i8 61, i8 32, i8 37, i8 108, i8 108, i8 100, i8 10, i8 0], align 1
@.str.06_struct_methods.5 = constant [23 x i8] [i8 82, i8 101, i8 99, i8 116, i8 97, i8 110, i8 103, i8 108, i8 101, i8 58, i8 32, i8 37, i8 108, i8 108, i8 100, i8 195, i8 151, i8 37, i8 108, i8 108, i8 100, i8 10, i8 0], align 1
@.str.06_struct_methods.6 = constant [15 x i8] [i8 32, i8 32, i8 97, i8 114, i8 101, i8 97, i8 32, i8 61, i8 32, i8 37, i8 108, i8 108, i8 100, i8 10, i8 0], align 1
@.str.06_struct_methods.7 = constant [20 x i8] [i8 32, i8 32, i8 112, i8 101, i8 114, i8 105, i8 109, i8 101, i8 116, i8 101, i8 114, i8 32, i8 61, i8 32, i8 37, i8 108, i8 108, i8 100, i8 10, i8 0], align 1
...
bb0:
  ...
  br label %bb1
bb1:
  %call_149 = call { i64, i64 } (i64, i64) @new(i64 10, i64 20)
  br label %bb2
bb2:
  %call_150 = call { i64, i64 } (i64, i64) @new(i64 5, i64 15)
  br label %bb3
bb3:
...
bb8:
  ...
  br label %bb9
bb9:
  %call_197 = call { i64, i64 } (i64, i64) @new(i64 10, i64 5)
  br label %bb10
bb10:
